...
public class FileDownload {
   ...
   public void func_224830_a(final WorldDownload p_224830_1_, final String p_224830_2_, final RealmsDownloadLatestWorldScreen.DownloadStatus p_224830_3_, final RealmsAnvilLevelStorageSource p_224830_4_) {
            ...
            public void run() {
               ...
               label1411: {
                  label1412: {
                     try {
                        flag = true;
                        FileDownload.this.field_224848_f = File.createTempFile("backup", ".tar.gz");
                        FileDownload.this.field_224850_h = new HttpGet(p_224830_1_.downloadLink);
                        closeablehttpclient = HttpClientBuilder.create().setDefaultRequestConfig(FileDownload.this.field_224852_j).build();
                        HttpResponse lvt_2_8_ = closeablehttpclient.execute(FileDownload.this.field_224850_h);
                        p_224830_3_.field_225140_b = Long.parseLong(lvt_2_8_.getFirstHeader("Content-Length").getValue());
                        if (lvt_2_8_.getStatusLine().getStatusCode() != 200) {
                           FileDownload.this.field_224846_d = true;
                           FileDownload.this.field_224850_h.abort();
                           flag = false;
                           break label1411;
                        }

                        OutputStream outputstream = new FileOutputStream(FileDownload.this.field_224848_f);
                        FileDownload.ProgressListener filedownload$progresslistener = FileDownload.this.new ProgressListener(p_224830_2_.trim(), FileDownload.this.field_224848_f, p_224830_4_, p_224830_3_, p_224830_1_);
                        FileDownload.DownloadCountingOutputStream filedownload$downloadcountingoutputstream = FileDownload.this.new DownloadCountingOutputStream(outputstream);
                        filedownload$downloadcountingoutputstream.func_224804_a(filedownload$progresslistener);
                        IOUtils.copy(lvt_2_8_.getEntity().getContent(), filedownload$downloadcountingoutputstream);
                        flag = false;
                     } catch (Exception exception4) {
                        FileDownload.field_224843_a.error("Caught exception while downloading: " + exception4.getMessage());
                        FileDownload.this.field_224846_d = true;
                        flag = false;
                        break label1412;
                     } finally {
                        if (flag) {
                           FileDownload.this.field_224850_h.releaseConnection();
                           if (FileDownload.this.field_224848_f != null) {
                              FileDownload.this.field_224848_f.delete();
                           }

                           if (!FileDownload.this.field_224846_d) {
                              if (!p_224830_1_.resourcePackUrl.isEmpty() && !p_224830_1_.resourcePackHash.isEmpty()) {
                                 try {
                                    FileDownload.this.field_224848_f = File.createTempFile("resources", ".tar.gz");
                                    FileDownload.this.field_224850_h = new HttpGet(p_224830_1_.resourcePackUrl);
                                    HttpResponse httpresponse = closeablehttpclient.execute(FileDownload.this.field_224850_h);
                                    ...
                                    OutputStream outputstream1 = new FileOutputStream(FileDownload.this.field_224848_f);
                                    FileDownload.ResourcePackProgressListener filedownload$resourcepackprogresslistener = FileDownload.this.new ResourcePackProgressListener(FileDownload.this.field_224848_f, p_224830_3_, p_224830_1_);
                                    FileDownload.DownloadCountingOutputStream filedownload$downloadcountingoutputstream2 = FileDownload.this.new DownloadCountingOutputStream(outputstream1);
                                    ...
                                    FileDownload.field_224843_a.error("Caught exception while downloading: " + exception.getMessage());
                                    FileDownload.this.field_224846_d = true;
                                 } finally {
                                    FileDownload.this.field_224850_h.releaseConnection();
                                    if (FileDownload.this.field_224848_f != null) {
                           ...
                           if (closeablehttpclient != null) {
                              try {
                                 ...
                                 FileDownload.field_224843_a.error("Failed to close Realms download client");
                              }
                           }
                     ...
                     if (!FileDownload.this.field_224846_d) {
                        if (!p_224830_1_.resourcePackUrl.isEmpty() && !p_224830_1_.resourcePackHash.isEmpty()) {
                           try {
                              FileDownload.this.field_224848_f = File.createTempFile("resources", ".tar.gz");
                              FileDownload.this.field_224850_h = new HttpGet(p_224830_1_.resourcePackUrl);
                              HttpResponse httpresponse2 = closeablehttpclient.execute(FileDownload.this.field_224850_h);
                              ...
                              OutputStream outputstream3 = new FileOutputStream(FileDownload.this.field_224848_f);
                              FileDownload.ResourcePackProgressListener filedownload$resourcepackprogresslistener2 = FileDownload.this.new ResourcePackProgressListener(FileDownload.this.field_224848_f, p_224830_3_, p_224830_1_);
                              FileDownload.DownloadCountingOutputStream filedownload$downloadcountingoutputstream4 = FileDownload.this.new DownloadCountingOutputStream(outputstream3);
                              ...
                              FileDownload.field_224843_a.error("Caught exception while downloading: " + exception3.getMessage());
                              FileDownload.this.field_224846_d = true;
                           } finally {
                              FileDownload.this.field_224850_h.releaseConnection();
                              if (FileDownload.this.field_224848_f != null) {
                  ...
                  if (!FileDownload.this.field_224846_d) {
                     if (!p_224830_1_.resourcePackUrl.isEmpty() && !p_224830_1_.resourcePackHash.isEmpty()) {
                        try {
                           FileDownload.this.field_224848_f = File.createTempFile("resources", ".tar.gz");
                           FileDownload.this.field_224850_h = new HttpGet(p_224830_1_.resourcePackUrl);
                           HttpResponse httpresponse1 = closeablehttpclient.execute(FileDownload.this.field_224850_h);
                           ...
                           OutputStream outputstream2 = new FileOutputStream(FileDownload.this.field_224848_f);
                           FileDownload.ResourcePackProgressListener filedownload$resourcepackprogresslistener1 = FileDownload.this.new ResourcePackProgressListener(FileDownload.this.field_224848_f, p_224830_3_, p_224830_1_);
                           FileDownload.DownloadCountingOutputStream filedownload$downloadcountingoutputstream3 = FileDownload.this.new DownloadCountingOutputStream(outputstream2);
                           ...
                           FileDownload.field_224843_a.error("Caught exception while downloading: " + exception2.getMessage());
                           FileDownload.this.field_224846_d = true;
                        } finally {
                           FileDownload.this.field_224850_h.releaseConnection();
                           if (FileDownload.this.field_224848_f != null) {
               ...
               if (!FileDownload.this.field_224846_d) {
                  if (!p_224830_1_.resourcePackUrl.isEmpty() && !p_224830_1_.resourcePackHash.isEmpty()) {
                     try {
                        FileDownload.this.field_224848_f = File.createTempFile("resources", ".tar.gz");
                        FileDownload.this.field_224850_h = new HttpGet(p_224830_1_.resourcePackUrl);
                        HttpResponse httpresponse3 = closeablehttpclient.execute(FileDownload.this.field_224850_h);
                        ...
                        OutputStream outputstream4 = new FileOutputStream(FileDownload.this.field_224848_f);
                        FileDownload.ResourcePackProgressListener filedownload$resourcepackprogresslistener3 = FileDownload.this.new ResourcePackProgressListener(FileDownload.this.field_224848_f, p_224830_3_, p_224830_1_);
                        FileDownload.DownloadCountingOutputStream filedownload$downloadcountingoutputstream1 = FileDownload.this.new DownloadCountingOutputStream(outputstream4);
                        ...
                        FileDownload.field_224843_a.error("Caught exception while downloading: " + exception1.getMessage());
                        FileDownload.this.field_224846_d = true;
                     } finally {
                        FileDownload.this.field_224850_h.releaseConnection();
                        if (FileDownload.this.field_224848_f != null) {
