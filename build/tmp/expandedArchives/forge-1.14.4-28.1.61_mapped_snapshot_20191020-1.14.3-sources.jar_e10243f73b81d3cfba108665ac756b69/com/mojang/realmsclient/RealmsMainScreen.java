...
public class RealmsMainScreen extends RealmsScreen {
   ...
   public void func_223901_c() {
      ...
      this.buttonsAdd(this.field_224010_R = new RealmsButton(5, this.width() / 2 + 52, this.func_223932_C() + 160 - 20, 98, 20, getLocalizedString("mco.selectServer.buy")) {
         public void onPress() {
            RealmsUtil.func_225190_c("https://minecraft.net/realms");
         }
      });
   ...
   private void func_223944_n() {
      (new Thread() {
         public void run() {
            ...
            pingresult.worldIds = RealmsMainScreen.this.func_223952_o();

            try {
               realmsclient.func_224903_a(pingresult);
            } catch (Throwable throwable) {
               RealmsMainScreen.field_224012_a.warn("Could not send ping result to Realms: ", throwable);
            }
   ...
   private void func_223930_q() {
      RealmsServer realmsserver = this.func_223967_a(this.field_224021_j);
      if (realmsserver != null) {
         String s = "https://account.mojang.com/buy/realms?sid=" + realmsserver.remoteSubscriptionId + "&pid=" + Realms.getUUID() + "&ref=" + (realmsserver.expiredTrial ? "expiredTrial" : "expiredRealm");
   ...
   private void func_223906_g(RealmsServer p_223906_1_) {
      if (!Realms.getUUID().equals(p_223906_1_.ownerUUID)) {
         this.func_223949_z();
   ...
   public boolean charTyped(char p_charTyped_1_, int p_charTyped_2_) {
      this.field_224002_J.forEach((p_223958_1_) -> {
         p_223958_1_.func_224799_a(p_charTyped_1_);
      });
      return true;
   }
   ...
   private void func_223980_b(int p_223980_1_, int p_223980_2_) {
      ...
      GlStateManager.popMatrix();
      RealmsScreen.bind(field_224016_e[this.field_223997_E]);
      GlStateManager.color4f(1.0F, 1.0F, 1.0F, 1.0F);
      GlStateManager.pushMatrix();
      ...
      if (this.field_223998_F % 95 < 5) {
         if (!this.field_223999_G) {
            if (this.field_223997_E == field_224016_e.length - 1) {
               this.field_223997_E = 0;
            } else {
               ++this.field_223997_E;
            }
      ...
      for(String s1 : list) {
         ...
         ++i1;
         this.drawString(s1, j1, j + 10 * i1 - 3, 5000268, false);
      }
         ...
         if (p_223733_1_.state == RealmsServer.Status.UNINITIALIZED) {
            ...
            if (RealmsMainScreen.this.func_223885_h(p_223733_1_) && p_223733_1_.expired) {
               ...
               if (p_223733_1_.worldType.equals(RealmsServer.ServerType.MINIGAME)) {
                  ...
                  RealmsMainScreen.this.drawString(p_223733_1_.getMinigameName(), p_223733_2_ + 2 + k, p_223733_3_ + 12, 7105644);
               } else {
                  RealmsMainScreen.this.drawString(p_223733_1_.getDescription(), p_223733_2_ + 2, p_223733_3_ + 12, 7105644);
               }

               if (!RealmsMainScreen.this.func_223885_h(p_223733_1_)) {
                  RealmsMainScreen.this.drawString(p_223733_1_.owner, p_223733_2_ + 2, p_223733_3_ + 12 + 11, 5000268);
               }
            }
   ...
   @OnlyIn(Dist.CLIENT)
   class ServerList extends RealmsObjectSelectionList {
      public ServerList() {
