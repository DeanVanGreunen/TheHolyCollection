...
public class RealmsBrokenWorldScreen extends RealmsScreen {
   ...
   private final List<Integer> field_224086_p = new ArrayList<>();
   ...
   private void func_224068_a(final long p_224068_1_) {
      (new Thread() {
         public void run() {
            RealmsClient realmsclient = RealmsClient.func_224911_a();

            try {
               RealmsBrokenWorldScreen.this.field_224074_d = realmsclient.func_224935_a(p_224068_1_);
               RealmsBrokenWorldScreen.this.func_224058_a();
            } catch (RealmsServiceException realmsserviceexception) {
               RealmsBrokenWorldScreen.field_224071_a.error("Couldn't get own world");
               Realms.setScreen(new RealmsGenericErrorScreen(realmsserviceexception.getMessage(), RealmsBrokenWorldScreen.this.field_224072_b));
            } catch (IOException var4) {
               RealmsBrokenWorldScreen.field_224071_a.error("Couldn't parse response getting own world");
            }
      ...
      if (!p_confirmResult_1_) {
         ...
         if (p_confirmResult_2_ != 13 && p_confirmResult_2_ != 14) {
            ...
            (new Thread() {
               public void run() {
                  RealmsClient realmsclient = RealmsClient.func_224911_a();
                  if (RealmsBrokenWorldScreen.this.field_224074_d.state.equals(RealmsServer.Status.CLOSED)) {
                     RealmsTasks.OpenServerTask realmstasks$openservertask = new RealmsTasks.OpenServerTask(RealmsBrokenWorldScreen.this.field_224074_d, RealmsBrokenWorldScreen.this, RealmsBrokenWorldScreen.this.field_224072_b, true);
                     RealmsLongRunningMcoTaskScreen realmslongrunningmcotaskscreen = new RealmsLongRunningMcoTaskScreen(RealmsBrokenWorldScreen.this, realmstasks$openservertask);
