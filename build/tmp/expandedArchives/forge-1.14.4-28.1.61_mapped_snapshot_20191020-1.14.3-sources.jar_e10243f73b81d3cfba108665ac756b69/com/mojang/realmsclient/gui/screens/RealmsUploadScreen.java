   ...
   private void func_224682_h() {
      ...
      (new Thread() {
         public void run() {
            ...
            long i = RealmsUploadScreen.this.field_224699_d;
            ...
            try {
               if (RealmsUploadScreen.field_224718_w.tryLock(1L, TimeUnit.SECONDS)) {
                  ...
                  file1 = RealmsUploadScreen.this.func_224675_b(new File(file2, RealmsUploadScreen.this.field_224698_c.getLevelId()));
                  if (RealmsUploadScreen.this.field_224706_k) {
                     RealmsUploadScreen.this.func_224676_i();
                     return;
                  }

                  if (RealmsUploadScreen.this.func_224692_a(file1)) {
                     ...
                     FileUpload fileupload = new FileUpload(file1, RealmsUploadScreen.this.field_224699_d, RealmsUploadScreen.this.field_224700_e, uploadinfo, Realms.getSessionId(), Realms.getName(), Realms.getMinecraftVersionString(), RealmsUploadScreen.this.field_224701_f);
                     fileupload.func_224874_a((p_225167_3_) -> {
                        if (p_225167_3_.field_225179_a >= 200 && p_225167_3_.field_225179_a < 300) {
                        ...
                        } else if (p_225167_3_.field_225179_a == 400 && p_225167_3_.field_225180_b != null) {
                           RealmsUploadScreen.this.field_224703_h = RealmsScreen.getLocalizedString("mco.upload.failed", p_225167_3_.field_225180_b);
                        } else {
                           RealmsUploadScreen.this.field_224703_h = RealmsScreen.getLocalizedString("mco.upload.failed", p_225167_3_.field_225179_a);
                        }
                  ...
                  long k = file1.length();
                  RealmsUploadScreen.Unit realmsuploadscreen$unit = RealmsUploadScreen.func_224665_b(k);
                  RealmsUploadScreen.Unit realmsuploadscreen$unit1 = RealmsUploadScreen.func_224665_b(5368709120L);
                  if (RealmsUploadScreen.func_224667_b(k, realmsuploadscreen$unit).equals(RealmsUploadScreen.func_224667_b(5368709120L, realmsuploadscreen$unit1)) && realmsuploadscreen$unit != RealmsUploadScreen.Unit.B) {
                     RealmsUploadScreen.Unit realmsuploadscreen$unit2 = RealmsUploadScreen.Unit.values()[realmsuploadscreen$unit.ordinal() - 1];
                     RealmsUploadScreen.this.field_224703_h = RealmsScreen.getLocalizedString("mco.upload.size.failure.line1", RealmsUploadScreen.this.field_224698_c.getLevelName()) + "\\n" + RealmsScreen.getLocalizedString("mco.upload.size.failure.line2", RealmsUploadScreen.func_224667_b(k, realmsuploadscreen$unit2), RealmsUploadScreen.func_224667_b(5368709120L, realmsuploadscreen$unit2));
                     return;
                  }

                  RealmsUploadScreen.this.field_224703_h = RealmsScreen.getLocalizedString("mco.upload.size.failure.line1", RealmsUploadScreen.this.field_224698_c.getLevelName()) + "\\n" + RealmsScreen.getLocalizedString("mco.upload.size.failure.line2", RealmsUploadScreen.func_224667_b(k, realmsuploadscreen$unit), RealmsUploadScreen.func_224667_b(5368709120L, realmsuploadscreen$unit1));
                  return;
               }
            } catch (IOException ioexception) {
               RealmsUploadScreen.this.field_224703_h = RealmsScreen.getLocalizedString("mco.upload.failed", ioexception.getMessage());
               return;
            } catch (RealmsServiceException realmsserviceexception) {
               RealmsUploadScreen.this.field_224703_h = RealmsScreen.getLocalizedString("mco.upload.failed", realmsserviceexception.toString());
               return;
               ...
               if (RealmsUploadScreen.field_224718_w.isHeldByCurrentThread()) {
                  ...
                  if (file1 != null) {
                     RealmsUploadScreen.field_224696_a.debug("Deleting file " + file1.getAbsolutePath());
                     file1.delete();
                  }
