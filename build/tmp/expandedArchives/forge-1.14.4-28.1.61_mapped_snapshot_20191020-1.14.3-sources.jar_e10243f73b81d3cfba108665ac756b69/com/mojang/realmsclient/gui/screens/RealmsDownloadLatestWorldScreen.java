...
public class RealmsDownloadLatestWorldScreen extends RealmsScreen {
   ...
   public void tick() {
      ...
      if (this.field_224184_j != null && this.field_224179_e.tryAcquire(1)) {
         ...
         if (this.field_224185_k != null) {
            ...
            arraylist.add(func_224153_a(this.field_224192_r));
         }
         ...
         String s = String.join(System.lineSeparator(), arraylist);
         Realms.narrateNow(s);
      }
   ...
   private void func_224165_h() {
      (new Thread() {
         public void run() {
            try {
               if (RealmsDownloadLatestWorldScreen.field_224199_y.tryLock(1L, TimeUnit.SECONDS)) {
                  RealmsDownloadLatestWorldScreen.this.field_224184_j = RealmsScreen.getLocalizedString("mco.download.preparing");
                  if (RealmsDownloadLatestWorldScreen.this.field_224186_l) {
                     RealmsDownloadLatestWorldScreen.this.func_224159_i();
                     return;
                  }

                  RealmsDownloadLatestWorldScreen.this.field_224184_j = RealmsScreen.getLocalizedString("mco.download.downloading", RealmsDownloadLatestWorldScreen.this.field_224181_g);
                  FileDownload filedownload = new FileDownload();
                  filedownload.func_224827_a(RealmsDownloadLatestWorldScreen.this.field_224177_c.downloadLink);
                  filedownload.func_224830_a(RealmsDownloadLatestWorldScreen.this.field_224177_c, RealmsDownloadLatestWorldScreen.this.field_224181_g, RealmsDownloadLatestWorldScreen.this.field_224182_h, RealmsDownloadLatestWorldScreen.this.getLevelStorageSource());

                  while(!filedownload.func_224835_b()) {
                     if (filedownload.func_224836_c()) {
                        filedownload.func_224834_a();
                        RealmsDownloadLatestWorldScreen.this.field_224183_i = RealmsScreen.getLocalizedString("mco.download.failed");
                        RealmsDownloadLatestWorldScreen.this.field_224180_f.setMessage(RealmsScreen.getLocalizedString("gui.done"));
                        return;
                     }

                     if (filedownload.func_224837_d()) {
                        RealmsDownloadLatestWorldScreen.this.field_224189_o = true;
                     }
                     ...
                     try {
                        ...
                        RealmsDownloadLatestWorldScreen.field_224175_a.error("Failed to check Realms backup download status");
                     }
                  }

                  RealmsDownloadLatestWorldScreen.this.field_224188_n = true;
                  RealmsDownloadLatestWorldScreen.this.field_224184_j = RealmsScreen.getLocalizedString("mco.download.done");
                  RealmsDownloadLatestWorldScreen.this.field_224180_f.setMessage(RealmsScreen.getLocalizedString("gui.done"));
                  return;
               }
            } catch (InterruptedException var9) {
               RealmsDownloadLatestWorldScreen.field_224175_a.error("Could not acquire upload lock");
               return;
               ...
               if (!RealmsDownloadLatestWorldScreen.field_224199_y.isHeldByCurrentThread()) {
                  return;
               }

               RealmsDownloadLatestWorldScreen.field_224199_y.unlock();
               RealmsDownloadLatestWorldScreen.this.field_224187_m = false;
               RealmsDownloadLatestWorldScreen.this.field_224188_n = true;
            }
