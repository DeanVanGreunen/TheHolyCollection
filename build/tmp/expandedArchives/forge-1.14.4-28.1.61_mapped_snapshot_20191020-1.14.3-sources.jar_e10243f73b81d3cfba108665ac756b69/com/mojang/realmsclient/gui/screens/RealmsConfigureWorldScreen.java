...
public class RealmsConfigureWorldScreen extends RealmsScreenWithCallback<WorldTemplate> implements RealmsServerSlotButton.IHandler {
   ...
   private void func_224387_a(final long p_224387_1_) {
      (new Thread() {
         public void run() {
            RealmsClient realmsclient = RealmsClient.func_224911_a();

            try {
               RealmsConfigureWorldScreen.this.field_224416_d = realmsclient.func_224935_a(p_224387_1_);
               ...
               Realms.setScreen(new RealmsGenericErrorScreen(realmsserviceexception.getMessage(), RealmsConfigureWorldScreen.this.field_224415_c));
   ...
   public void func_224366_a(int p_224366_1_, @Nonnull RealmsServerSlotButton.Action p_224366_2_, boolean p_224366_3_, boolean p_224366_4_) {
      switch(p_224366_2_) {
      case NOTHING:
         break;
      case JOIN:
   ...
   private void func_224403_a(int p_224403_1_, RealmsServer p_224403_2_) {
      ...
      Realms.setScreen(new RealmsLongConfirmationScreen((p_224380_3_, p_224380_4_) -> {
         if (p_224380_3_) {
   ...
   private void func_224388_b(int p_224388_1_, RealmsServer p_224388_2_) {
      String s = getLocalizedString("mco.configure.world.slot.switch.question.line1");
      String s1 = getLocalizedString("mco.configure.world.slot.switch.question.line2");
      Realms.setScreen(new RealmsLongConfirmationScreen((p_224392_3_, p_224392_4_) -> {
         if (p_224392_3_) {
   ...
   private void func_224406_a(long p_224406_1_, int p_224406_3_) {
      ...
      RealmsTasks.SwitchSlotTask realmstasks$switchslottask = new RealmsTasks.SwitchSlotTask(p_224406_1_, p_224406_3_, (p_224372_1_, p_224372_2_) -> {
