...
public class RealmsPlayerScreen extends RealmsScreen {
   ...
   public void render(int p_render_1_, int p_render_2_, float p_render_3_) {
      ...
      tezzelator.vertex(0.0D, (double)this.height(), 0.0D).tex(0.0D, (double)((float)(this.height() - i) / 32.0F + 0.0F)).color(64, 64, 64, 255).endVertex();
      tezzelator.vertex((double)this.width(), (double)this.height(), 0.0D).tex((double)((float)this.width() / 32.0F), (double)((float)(this.height() - i) / 32.0F + 0.0F)).color(64, 64, 64, 255).endVertex();
      tezzelator.vertex((double)this.width(), (double)i, 0.0D).tex((double)((float)this.width() / 32.0F), 0.0D).color(64, 64, 64, 255).endVertex();
      tezzelator.vertex(0.0D, (double)i, 0.0D).tex(0.0D, 0.0D).color(64, 64, 64, 255).endVertex();
      tezzelator.end();
