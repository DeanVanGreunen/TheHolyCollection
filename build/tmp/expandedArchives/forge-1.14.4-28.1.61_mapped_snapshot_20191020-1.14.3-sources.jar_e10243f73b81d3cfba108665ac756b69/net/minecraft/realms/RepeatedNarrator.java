...
class RepeatedNarrator {
   ...
   public void narrate(String p_narrate_1_) {
      RepeatedNarrator.Parameter repeatednarrator$parameter = this.params.updateAndGet((p_214464_2_) -> {
         return p_214464_2_ != null && p_narrate_1_.equals(p_214464_2_.field_214462_a) ? p_214464_2_ : new RepeatedNarrator.Parameter(p_narrate_1_, RateLimiter.create((double)this.permitsPerSecond));
      });
