...
public class RealmsScreenProxy extends Screen {
   ...
   public void narrateLabels() {
      List<String> list = this.children.stream().filter((p_212982_0_) -> {
         return p_212982_0_ instanceof RealmsLabelProxy;
      }).map((p_212981_0_) -> {
         return ((RealmsLabelProxy)p_212981_0_).getLabel().getText();
