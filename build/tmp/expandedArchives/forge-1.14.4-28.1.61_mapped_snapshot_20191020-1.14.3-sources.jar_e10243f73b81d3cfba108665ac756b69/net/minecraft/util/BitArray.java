...
public class BitArray {
   ...
   public int func_219789_a(int p_219789_1_, int p_219789_2_) {
      ...
      int i = p_219789_1_ * this.bitsPerEntry;
      int j = i >> 6;
      int k = (p_219789_1_ + 1) * this.bitsPerEntry - 1 >> 6;
      int l = i ^ j << 6;
      int i1 = 0;
      i1 = i1 | (int)(this.longArray[j] >>> l & this.maxEntryValue);
      this.longArray[j] = this.longArray[j] & ~(this.maxEntryValue << l) | ((long)p_219789_2_ & this.maxEntryValue) << l;
      if (j != k) {
         int j1 = 64 - l;
         int k1 = this.bitsPerEntry - j1;
         i1 |= (int)(this.longArray[k] << j1 & this.maxEntryValue);
         this.longArray[k] = this.longArray[k] >>> k1 << k1 | ((long)p_219789_2_ & this.maxEntryValue) >> j1;
      }
   ...
   public void func_225421_a(IntConsumer p_225421_1_) {
      ...
      if (i != 0) {
         ...
         for(int i1 = 0; i1 < this.arraySize; ++i1) {
            ...
            if (k1 == l1) {
               p_225421_1_.accept((int)(k >>> i2 & this.maxEntryValue));
            } else {
               int j2 = 64 - i2;
               p_225421_1_.accept((int)((k >>> i2 | l << j2) & this.maxEntryValue));
            }
         }
