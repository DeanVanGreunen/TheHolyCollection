...
public class EntitySelectionContext implements ISelectionContext {
   ...
   protected EntitySelectionContext(Entity entityIn) {
      this(entityIn, entityIn.isSneaking(), entityIn.getBoundingBox().minY, entityIn instanceof LivingEntity ? ((LivingEntity)entityIn).getHeldItemMainhand().getItem() : Items.AIR);
   }
