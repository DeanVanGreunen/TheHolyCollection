...
public class RenamedRecipes extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      if (!Objects.equals(type, this.getInputSchema().getType(TypeReferences.RECIPE))) {
         ...
         return this.fixTypeEverywhere("Recipes fix", type, (p_209670_0_) -> {
            return (p_209671_0_) -> {
               return p_209671_0_.mapSecond((p_209672_0_) -> {
                  return field_209673_a.getOrDefault(p_209672_0_, p_209672_0_);
               });
            };
         });
      }
