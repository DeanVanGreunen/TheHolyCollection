...
public class ScheduleCommand {
   ...
   public static void register(CommandDispatcher<CommandSource> p_218909_0_) {
      ...
      }).then(Commands.literal("function").then(Commands.argument("function", FunctionArgument.func_200021_a()).suggests(FunctionCommand.FUNCTION_SUGGESTER).then(Commands.argument("time", TimeArgument.func_218091_a()).executes((p_218911_0_) -> {
