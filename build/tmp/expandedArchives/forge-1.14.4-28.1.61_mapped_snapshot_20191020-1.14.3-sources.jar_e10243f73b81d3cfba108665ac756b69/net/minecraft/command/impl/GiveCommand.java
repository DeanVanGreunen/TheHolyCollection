      ...
      for(ServerPlayerEntity serverplayerentity : targets) {
         ...
         while(i > 0) {
            ...
            if (flag && itemstack.isEmpty()) {
               ...
               serverplayerentity.world.playSound((PlayerEntity)null, serverplayerentity.posX, serverplayerentity.posY, serverplayerentity.posZ, SoundEvents.ENTITY_ITEM_PICKUP, SoundCategory.PLAYERS, 0.2F, ((serverplayerentity.getRNG().nextFloat() - serverplayerentity.getRNG().nextFloat()) * 0.7F + 1.0F) * 2.0F);
