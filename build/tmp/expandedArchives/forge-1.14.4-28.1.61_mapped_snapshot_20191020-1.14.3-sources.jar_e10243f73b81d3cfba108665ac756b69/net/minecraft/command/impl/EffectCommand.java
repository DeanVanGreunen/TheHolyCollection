...
public class EffectCommand {
   ...
   public static void register(CommandDispatcher<CommandSource> dispatcher) {
      ...
      }).then(Commands.literal("clear").then(Commands.argument("targets", EntityArgument.entities()).executes((p_198352_0_) -> {
      ...
      })))).then(Commands.literal("give").then(Commands.argument("targets", EntityArgument.entities()).then(Commands.argument("effect", PotionArgument.mobEffect()).executes((p_198351_0_) -> {
