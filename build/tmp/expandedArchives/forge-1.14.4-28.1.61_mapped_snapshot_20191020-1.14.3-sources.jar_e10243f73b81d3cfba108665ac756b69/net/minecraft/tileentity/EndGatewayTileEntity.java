...
public class EndGatewayTileEntity extends EndPortalTileEntity implements ITickableTileEntity {
   ...
   private void findExitPortal() {
      ...
      if (this.exitPortal == null) {
         ...
         Feature.END_ISLAND.place(this.world, this.world.getChunkProvider().getChunkGenerator(), new Random(this.exitPortal.toLong()), this.exitPortal, IFeatureConfig.NO_FEATURE_CONFIG);
      } else {
   ...
   private void createExitPortal(BlockPos posIn) {
      Feature.END_GATEWAY.place(this.world, this.world.getChunkProvider().getChunkGenerator(), new Random(), posIn, EndGatewayConfig.func_214702_a(this.getPos(), false));
   }
