         ...
         if (blockitemusecontext.canPlace() && world.getBlockState(blockpos1).isReplaceable(blockitemusecontext)) {
            ...
            if (!list.isEmpty()) {
               ...
               if (!world.isRemote) {
                  ...
                  world.playSound((PlayerEntity)null, armorstandentity.posX, armorstandentity.posY, armorstandentity.posZ, SoundEvents.ENTITY_ARMOR_STAND_PLACE, SoundCategory.BLOCKS, 0.75F, 0.8F);
               }
