...
public class Items {
   ...
   public static final Item WOODEN_HOE = register("wooden_hoe", new HoeItem(ItemTier.WOOD, -3.0F, (new Item.Properties()).group(ItemGroup.TOOLS)));
   ...
   public static final Item IRON_HOE = register("iron_hoe", new HoeItem(ItemTier.IRON, -1.0F, (new Item.Properties()).group(ItemGroup.TOOLS)));
   ...
   public static final Item GOLDEN_HOE = register("golden_hoe", new HoeItem(ItemTier.GOLD, -3.0F, (new Item.Properties()).group(ItemGroup.TOOLS)));
   ...
   public static final Item CLOCK = register("clock", new ClockItem((new Item.Properties()).group(ItemGroup.TOOLS)));
   ...
   public static final Item ZOMBIE_PIGMAN_SPAWN_EGG = register("zombie_pigman_spawn_egg", new SpawnEggItem(EntityType.ZOMBIE_PIGMAN, 15373203, 5009705, (new Item.Properties()).group(ItemGroup.MISC)));
   ...
   public static final Item CARROT_ON_A_STICK = register("carrot_on_a_stick", new CarrotOnAStickItem((new Item.Properties()).maxDamage(25).group(ItemGroup.TRANSPORTATION)));
