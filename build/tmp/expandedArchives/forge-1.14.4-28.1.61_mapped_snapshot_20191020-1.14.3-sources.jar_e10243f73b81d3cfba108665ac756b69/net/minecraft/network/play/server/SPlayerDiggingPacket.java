...
public class SPlayerDiggingPacket implements IPacket<IClientPlayNetHandler> {
   ...
   public SPlayerDiggingPacket(BlockPos p_i51704_1_, BlockState p_i51704_2_, CPlayerDiggingPacket.Action p_i51704_3_, boolean p_i51704_4_) {
      this.field_225380_c = p_i51704_1_.toImmutable();
      this.field_225381_d = p_i51704_2_;
      this.field_225378_a = p_i51704_3_;
      this.field_225382_e = p_i51704_4_;
   }
