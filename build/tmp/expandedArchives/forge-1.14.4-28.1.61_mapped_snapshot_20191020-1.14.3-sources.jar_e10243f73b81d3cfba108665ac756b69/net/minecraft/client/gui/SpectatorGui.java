...
public class SpectatorGui extends AbstractGui implements ISpectatorMenuRecipient {
   ...
   public void renderTooltip(float p_195622_1_) {
      if (this.menu != null) {
         ...
         if (f <= 0.0F) {
            ...
            this.blitOffset = -90;
            int k = MathHelper.floor((float)this.mc.mainWindow.getScaledHeight() - 22.0F * f);
   ...
   protected void func_214456_a(float p_214456_1_, int p_214456_2_, int p_214456_3_, SpectatorDetails p_214456_4_) {
      ...
      GlStateManager.color4f(1.0F, 1.0F, 1.0F, p_214456_1_);
      ...
      for(int i = 0; i < 9; ++i) {
         this.renderSlot(i, this.mc.mainWindow.getScaledWidth() / 2 - 90 + i * 20 + 2, (float)(p_214456_3_ + 3), p_214456_1_, p_214456_4_.getObject(i));
      }
