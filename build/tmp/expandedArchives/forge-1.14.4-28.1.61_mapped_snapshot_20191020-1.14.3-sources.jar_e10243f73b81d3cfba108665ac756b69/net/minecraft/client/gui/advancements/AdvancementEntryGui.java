...
public class AdvancementEntryGui extends AbstractGui {
   ...
   public void drawConnectivity(int p_191819_1_, int p_191819_2_, boolean p_191819_3_) {
      ...
      for(AdvancementEntryGui advancemententrygui : this.children) {
         advancemententrygui.drawConnectivity(p_191819_1_, p_191819_2_, p_191819_3_);
      }
   ...
   public void draw(int p_191817_1_, int p_191817_2_) {
      ...
      for(AdvancementEntryGui advancemententrygui : this.children) {
         advancemententrygui.draw(p_191817_1_, p_191817_2_);
      }
   ...
   public void drawHover(int p_191821_1_, int p_191821_2_, float p_191821_3_, int p_191821_4_, int p_191821_5_) {
      ...
      this.blit(p_191821_1_ + this.x + 3, p_191821_2_ + this.y, this.displayInfo.getFrame().getIcon(), 128 + advancementstate2.getId() * 26, 26, 26);
      if (flag) {
         this.minecraft.fontRenderer.drawStringWithShadow(this.title, (float)(i1 + 5), (float)(p_191821_2_ + this.y + 9), -1);
         if (s != null) {
            this.minecraft.fontRenderer.drawStringWithShadow(s, (float)(p_191821_1_ + this.x - i), (float)(p_191821_2_ + this.y + 9), -1);
         }
      } else {
         this.minecraft.fontRenderer.drawStringWithShadow(this.title, (float)(p_191821_1_ + this.x + 32), (float)(p_191821_2_ + this.y + 9), -1);
         if (s != null) {
            this.minecraft.fontRenderer.drawStringWithShadow(s, (float)(p_191821_1_ + this.x + this.width - i - 5), (float)(p_191821_2_ + this.y + 9), -1);
         }
      }

      if (flag1) {
         for(int k1 = 0; k1 < this.description.size(); ++k1) {
            this.minecraft.fontRenderer.drawString(this.description.get(k1), (float)(i1 + 5), (float)(l + 26 - j1 + 7 + k1 * 9), -5592406);
         }
      } else {
         for(int l1 = 0; l1 < this.description.size(); ++l1) {
            this.minecraft.fontRenderer.drawString(this.description.get(l1), (float)(i1 + 5), (float)(p_191821_2_ + this.y + 9 + 17 + l1 * 9), -5592406);
         }
      }
