...
public abstract class AbstractCommandBlockScreen extends Screen {
   ...
   protected void computeSuggestions() {
      ...
      CommandDispatcher<ISuggestionProvider> commanddispatcher = this.minecraft.player.connection.getCommandDispatcher();
   ...
   private void func_209108_a(TextFormatting p_209108_1_) {
      ...
      Map<CommandNode<ISuggestionProvider>, String> map = this.minecraft.player.connection.getCommandDispatcher().getSmartUsage(suggestioncontext.parent, this.minecraft.player.connection.getSuggestionProvider());
