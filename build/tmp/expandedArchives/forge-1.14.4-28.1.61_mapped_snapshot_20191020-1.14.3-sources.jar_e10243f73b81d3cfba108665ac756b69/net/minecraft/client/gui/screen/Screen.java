...
public abstract class Screen extends FocusableGui implements IRenderable {
   ...
   public static boolean hasControlDown() {
      if (Minecraft.IS_RUNNING_ON_MAC) {
         return InputMappings.isKeyDown(Minecraft.getInstance().mainWindow.getHandle(), 343) || InputMappings.isKeyDown(Minecraft.getInstance().mainWindow.getHandle(), 347);
      } else {
         return InputMappings.isKeyDown(Minecraft.getInstance().mainWindow.getHandle(), 341) || InputMappings.isKeyDown(Minecraft.getInstance().mainWindow.getHandle(), 345);
      }
   }
   ...
   public static boolean hasAltDown() {
      return InputMappings.isKeyDown(Minecraft.getInstance().mainWindow.getHandle(), 342) || InputMappings.isKeyDown(Minecraft.getInstance().mainWindow.getHandle(), 346);
   }
