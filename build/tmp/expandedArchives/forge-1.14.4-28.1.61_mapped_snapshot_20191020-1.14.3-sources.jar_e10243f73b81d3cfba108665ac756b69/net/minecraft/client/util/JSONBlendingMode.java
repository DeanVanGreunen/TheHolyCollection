...
public class JSONBlendingMode {
   ...
   public void apply() {
      if (!this.equals(lastApplied)) {
         ...
         GlStateManager.blendEquation(this.blendFunction);
         if (this.separateBlend) {
            GlStateManager.blendFuncSeparate(this.srcColorFactor, this.destColorFactor, this.srcAlphaFactor, this.destAlphaFactor);
         } else {
