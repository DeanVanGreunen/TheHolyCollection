...
public class PointOfInterestDebugRenderer implements DebugRenderer.IDebugRenderer {
   ...
   private void func_217708_b() {
      BlockPos blockpos = this.func_217709_c().getBlockPos();
      ...
      this.field_217715_e.values().forEach((p_222917_1_) -> {
         if (this.func_217694_d(p_222917_1_)) {
            this.func_217704_b(p_222917_1_);
         }
   ...
   private void func_222918_b(PointOfInterestDebugRenderer.BrainInfo p_222918_1_) {
      if (p_222918_1_.field_222930_g != null) {
         PathfindingDebugRenderer.func_222911_a(this.func_217709_c(), p_222918_1_.field_222930_g, 0.5F, false, false);
      }

   }

   private void func_217704_b(PointOfInterestDebugRenderer.BrainInfo p_217704_1_) {
      boolean flag = this.func_217703_c(p_217704_1_);
      int i = 0;
      func_217693_a(p_217704_1_.field_217750_d, i, p_217704_1_.field_217749_c, -1, 0.03F);
      ++i;
      if (flag) {
         func_217693_a(p_217704_1_.field_217750_d, i, p_217704_1_.field_222928_d + " " + p_217704_1_.field_222929_e + "xp", -1, 0.02F);
         ++i;
      }

      if (flag && !p_217704_1_.field_223455_g.equals("")) {
         func_217693_a(p_217704_1_.field_217750_d, i, p_217704_1_.field_223455_g, -98404, 0.02F);
         ++i;
      }

      if (flag) {
         for(String s : p_217704_1_.field_217752_f) {
            func_217693_a(p_217704_1_.field_217750_d, i, s, -16711681, 0.02F);
            ++i;
         }
      }

      if (flag) {
         for(String s1 : p_217704_1_.field_217751_e) {
            func_217693_a(p_217704_1_.field_217750_d, i, s1, -16711936, 0.02F);
            ++i;
         }
      }

      if (p_217704_1_.field_223456_i) {
         func_217693_a(p_217704_1_.field_217750_d, i, "Wants Golem", -23296, 0.02F);
         ++i;
      }

      if (flag) {
         for(String s2 : p_217704_1_.field_223457_m) {
            if (s2.startsWith(p_217704_1_.field_217749_c)) {
               func_217693_a(p_217704_1_.field_217750_d, i, s2, -1, 0.02F);
            } else {
               func_217693_a(p_217704_1_.field_217750_d, i, s2, -23296, 0.02F);
            }
      ...
      if (flag) {
         for(String s3 : Lists.reverse(p_217704_1_.field_217753_g)) {
            func_217693_a(p_217704_1_.field_217750_d, i, s3, -3355444, 0.02F);
            ++i;
         }
      }

      if (flag) {
         this.func_222918_b(p_217704_1_);
      }
   ...
   private Set<String> func_217696_c(PointOfInterestDebugRenderer.POIInfo p_217696_1_) {
      return this.func_217697_c(p_217696_1_.field_217755_a).stream().map(RandomObjectDescriptor::func_218810_a).collect(Collectors.toSet());
   }
   ...
   private boolean func_217694_d(PointOfInterestDebugRenderer.BrainInfo p_217694_1_) {
      ...
      BlockPos blockpos = new BlockPos(playerentity.posX, p_217694_1_.field_217750_d.getY(), playerentity.posZ);
