         ...
         for(BlockPart blockpart : this.getElements()) {
            for(Direction direction : blockpart.mapFaces.keySet()) {
               ...
               if (blockpartface.cullFace == null) {
                  ...
                  simplebakedmodel$builder.addFaceQuad(p_217644_4_.getState().apply(java.util.Optional.empty()).map(trsr -> trsr.rotateTransform(blockpartface.cullFace)).orElse(blockpartface.cullFace), makeBakedQuad(blockpart, blockpartface, textureatlassprite1, direction, p_217644_4_));
               }
            }
         }
