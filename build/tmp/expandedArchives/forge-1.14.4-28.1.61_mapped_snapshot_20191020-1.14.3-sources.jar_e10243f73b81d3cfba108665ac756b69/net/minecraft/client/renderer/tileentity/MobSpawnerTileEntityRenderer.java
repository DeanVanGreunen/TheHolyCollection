...
public class MobSpawnerTileEntityRenderer extends TileEntityRenderer<MobSpawnerTileEntity> {
   public void render(MobSpawnerTileEntity tileEntityIn, double x, double y, double z, float partialTicks, int destroyStage) {
    ...
    */
   public static void renderMob(AbstractSpawner mobSpawnerLogic, double posX, double posY, double posZ, float partialTicks) {
