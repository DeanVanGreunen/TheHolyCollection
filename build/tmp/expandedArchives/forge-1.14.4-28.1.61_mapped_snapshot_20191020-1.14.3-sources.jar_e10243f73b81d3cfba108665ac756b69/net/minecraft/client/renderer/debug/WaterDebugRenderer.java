   ...
   public void render(long p_217676_1_) {
      ...
      for(BlockPos blockpos1 : BlockPos.getAllInBoxMutable(blockpos.add(-10, -10, -10), blockpos.add(10, 10, 10))) {
         ...
         if (ifluidstate.isTagged(FluidTags.WATER)) {
            double d3 = (double)((float)blockpos1.getY() + ifluidstate.getActualHeight(iworldreader, blockpos1));
      ...
      for(BlockPos blockpos2 : BlockPos.getAllInBoxMutable(blockpos.add(-10, -10, -10), blockpos.add(10, 10, 10))) {
         ...
         if (ifluidstate1.isTagged(FluidTags.WATER)) {
            DebugRenderer.func_217732_a(String.valueOf(ifluidstate1.getLevel()), (double)blockpos2.getX() + 0.5D, (double)((float)blockpos2.getY() + ifluidstate1.getActualHeight(iworldreader, blockpos2)), (double)blockpos2.getZ() + 0.5D, -16777216);
         }
      }
