...
public class CatModel<T extends CatEntity> extends OcelotModel<T> {
   ...
   public void setRotationAngles(T entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor) {
      ...
      if (this.field_217155_m > 0.0F) {
         this.ocelotHead.rotateAngleZ = this.func_217154_a(this.ocelotHead.rotateAngleZ, -1.2707963F, this.field_217155_m);
         this.ocelotHead.rotateAngleY = this.func_217154_a(this.ocelotHead.rotateAngleY, 1.2707963F, this.field_217155_m);
         ...
         this.ocelotTail.rotateAngleX = this.func_217154_a(this.ocelotTail.rotateAngleX, 0.8F, this.field_217156_n);
         this.ocelotTail2.rotateAngleX = this.func_217154_a(this.ocelotTail2.rotateAngleX, -0.4F, this.field_217156_n);
      }

      if (this.field_217157_o > 0.0F) {
         this.ocelotHead.rotateAngleX = this.func_217154_a(this.ocelotHead.rotateAngleX, -0.58177644F, this.field_217157_o);
      }
