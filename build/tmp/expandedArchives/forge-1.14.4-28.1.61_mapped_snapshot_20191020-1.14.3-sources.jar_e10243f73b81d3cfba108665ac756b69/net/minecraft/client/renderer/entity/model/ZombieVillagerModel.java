...
public class ZombieVillagerModel<T extends ZombieEntity> extends BipedModel<T> implements IHeadToggle {
   ...
   public ZombieVillagerModel(float p_i51058_1_, boolean p_i51058_2_) {
      ...
      if (p_i51058_2_) {
         ...
         this.bipedHead.addBox(-4.0F, -10.0F, -4.0F, 8, 8, 8, p_i51058_1_);
         this.bipedBody = new RendererModel(this, 16, 16);
         this.bipedBody.addBox(-4.0F, 0.0F, -2.0F, 8, 12, 4, p_i51058_1_ + 0.1F);
         ...
         this.bipedHead = new RendererModel(this, 0, 0);
         this.bipedHead.setTextureOffset(0, 0).addBox(-4.0F, -10.0F, -4.0F, 8, 10, 8, p_i51058_1_);
         this.bipedHead.setTextureOffset(24, 0).addBox(-1.0F, -3.0F, -6.0F, 2, 4, 2, p_i51058_1_);
         ...
         this.bipedBody.addBox(-4.0F, 0.0F, -3.0F, 8, 12, 6, p_i51058_1_);
         this.bipedBody.setTextureOffset(0, 38).addBox(-4.0F, 0.0F, -3.0F, 8, 18, 6, p_i51058_1_ + 0.05F);
