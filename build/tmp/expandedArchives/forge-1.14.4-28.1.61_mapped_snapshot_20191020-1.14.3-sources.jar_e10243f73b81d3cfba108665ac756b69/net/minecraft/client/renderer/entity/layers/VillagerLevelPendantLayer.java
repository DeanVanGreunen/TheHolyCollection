...
public class VillagerLevelPendantLayer<T extends LivingEntity & IVillagerDataHolder, M extends EntityModel<T> & IHeadToggle> extends LayerRenderer<T, M> implements IResourceManagerReloadListener {
   ...
   public void render(T entityIn, float p_212842_2_, float p_212842_3_, float p_212842_4_, float p_212842_5_, float p_212842_6_, float p_212842_7_, float p_212842_8_) {
      if (!entityIn.isInvisible()) {
         VillagerData villagerdata = ((IVillagerDataHolder)entityIn).getVillagerData();
         ...
         this.bindTexture(this.func_215351_a("type", Registry.VILLAGER_TYPE.getKey(ivillagertype)));
         ...
         if (villagerprofession != VillagerProfession.NONE && !entityIn.isChild()) {
            this.bindTexture(this.func_215351_a("profession", Registry.VILLAGER_PROFESSION.getKey(villagerprofession)));
            m.render(entityIn, p_212842_2_, p_212842_3_, p_212842_5_, p_212842_6_, p_212842_7_, p_212842_8_);
            this.bindTexture(this.func_215351_a("profession_level", field_215352_a.get(MathHelper.clamp(villagerdata.getLevel(), 1, field_215352_a.size()))));
            m.render(entityIn, p_212842_2_, p_212842_3_, p_212842_5_, p_212842_6_, p_212842_7_, p_212842_8_);
         }
