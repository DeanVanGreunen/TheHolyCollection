   ...
   public void setupTerrain(ActiveRenderInfo p_215320_1_, ICamera p_215320_2_, int p_215320_3_, boolean p_215320_4_) {
      ...
      for(WorldRenderer.LocalRenderInformationContainer worldrenderer$localrenderinformationcontainer2 : this.renderInfos) {
         ...
         if (chunkrender4.needsUpdate() || set.contains(chunkrender4)) {
            ...
            if (net.minecraftforge.common.ForgeConfig.CLIENT.alwaysSetupTerrainOffThread.get() || !chunkrender4.needsImmediateUpdate() && !flag3) {
   ...
   public void playEvent(PlayerEntity player, int type, BlockPos blockPosIn, int data) {
      ...
      case 2001:
         ...
         if (!blockstate.isAir(this.world, blockPosIn)) {
            SoundType soundtype = blockstate.getSoundType(world, blockPosIn, null);
