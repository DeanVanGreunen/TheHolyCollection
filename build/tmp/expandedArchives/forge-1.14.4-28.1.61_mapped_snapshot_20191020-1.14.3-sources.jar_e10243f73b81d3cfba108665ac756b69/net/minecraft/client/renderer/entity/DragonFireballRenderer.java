...
public class DragonFireballRenderer extends EntityRenderer<DragonFireballEntity> {
   ...
   public void doRender(DragonFireballEntity entity, double x, double y, double z, float entityYaw, float partialTicks) {
   ...
   protected ResourceLocation getEntityTexture(DragonFireballEntity entity) {
