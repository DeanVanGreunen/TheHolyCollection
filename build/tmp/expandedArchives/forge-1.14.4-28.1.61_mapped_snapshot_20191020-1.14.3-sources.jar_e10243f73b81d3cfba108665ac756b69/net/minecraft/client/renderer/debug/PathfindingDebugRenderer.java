...
public class PathfindingDebugRenderer implements DebugRenderer.IDebugRenderer {
   ...
   private static void func_222910_b(ActiveRenderInfo p_222910_0_, Path p_222910_1_, float p_222910_2_, boolean p_222910_3_, boolean p_222910_4_) {
      ...
      BlockPos blockpos = p_222910_1_.func_224770_k();
      if (func_225330_a(p_222910_0_, blockpos) <= 40.0F) {
         DebugRenderer.func_217730_a((new AxisAlignedBB((double)((float)blockpos.getX() + 0.25F), (double)((float)blockpos.getY() + 0.25F), (double)blockpos.getZ() + 0.25D, (double)((float)blockpos.getX() + 0.75F), (double)((float)blockpos.getY() + 0.75F), (double)((float)blockpos.getZ() + 0.75F))).offset(-d0, -d1, -d2), 0.0F, 1.0F, 0.0F, 0.5F);

         for(int i = 0; i < p_222910_1_.getCurrentPathLength(); ++i) {
            PathPoint pathpoint = p_222910_1_.getPathPointFromIndex(i);
            if (func_225330_a(p_222910_0_, pathpoint.func_224759_a()) <= 40.0F) {
               float f = i == p_222910_1_.getCurrentPathIndex() ? 1.0F : 0.0F;
               float f1 = i == p_222910_1_.getCurrentPathIndex() ? 0.0F : 1.0F;
               DebugRenderer.func_217730_a((new AxisAlignedBB((double)((float)pathpoint.x + 0.5F - p_222910_2_), (double)((float)pathpoint.y + 0.01F * (float)i), (double)((float)pathpoint.z + 0.5F - p_222910_2_), (double)((float)pathpoint.x + 0.5F + p_222910_2_), (double)((float)pathpoint.y + 0.25F + 0.01F * (float)i), (double)((float)pathpoint.z + 0.5F + p_222910_2_))).offset(-d0, -d1, -d2), f, 0.0F, f1, 0.5F);
            }
         }
      }

      if (p_222910_3_) {
         for(PathPoint pathpoint2 : p_222910_1_.getClosedSet()) {
            if (func_225330_a(p_222910_0_, pathpoint2.func_224759_a()) <= 40.0F) {
               DebugRenderer.func_217732_a(String.format("%s", pathpoint2.nodeType), (double)pathpoint2.x + 0.5D, (double)pathpoint2.y + 0.75D, (double)pathpoint2.z + 0.5D, -65536);
               DebugRenderer.func_217732_a(String.format(Locale.ROOT, "%.2f", pathpoint2.costMalus), (double)pathpoint2.x + 0.5D, (double)pathpoint2.y + 0.25D, (double)pathpoint2.z + 0.5D, -65536);
            }
         }

         for(PathPoint pathpoint3 : p_222910_1_.getOpenSet()) {
            if (func_225330_a(p_222910_0_, pathpoint3.func_224759_a()) <= 40.0F) {
               DebugRenderer.func_217732_a(String.format("%s", pathpoint3.nodeType), (double)pathpoint3.x + 0.5D, (double)pathpoint3.y + 0.75D, (double)pathpoint3.z + 0.5D, -16776961);
               DebugRenderer.func_217732_a(String.format(Locale.ROOT, "%.2f", pathpoint3.costMalus), (double)pathpoint3.x + 0.5D, (double)pathpoint3.y + 0.25D, (double)pathpoint3.z + 0.5D, -16776961);
            }
         }
      }
      ...
      if (p_222910_4_) {
         for(int j = 0; j < p_222910_1_.getCurrentPathLength(); ++j) {
            PathPoint pathpoint1 = p_222910_1_.getPathPointFromIndex(j);
            if (func_225330_a(p_222910_0_, pathpoint1.func_224759_a()) <= 40.0F) {
   ...
   public static void func_222912_a(ActiveRenderInfo p_222912_0_, Path p_222912_1_) {
      ...
      for(int i = 0; i < p_222912_1_.getCurrentPathLength(); ++i) {
         ...
         if (!(func_225330_a(p_222912_0_, pathpoint.func_224759_a()) > 40.0F)) {
   ...
   private static float func_225330_a(ActiveRenderInfo p_225330_0_, BlockPos p_225330_1_) {
      return (float)(Math.abs((double)p_225330_1_.getX() - p_225330_0_.getProjectedView().x) + Math.abs((double)p_225330_1_.getY() - p_225330_0_.getProjectedView().y) + Math.abs((double)p_225330_1_.getZ() - p_225330_0_.getProjectedView().z));
   }
