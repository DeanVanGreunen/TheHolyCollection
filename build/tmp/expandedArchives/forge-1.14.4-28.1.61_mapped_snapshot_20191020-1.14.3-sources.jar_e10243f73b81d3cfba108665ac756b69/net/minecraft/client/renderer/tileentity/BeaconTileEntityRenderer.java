...
public class BeaconTileEntityRenderer extends TileEntityRenderer<BeaconTileEntity> {
   ...
   private void func_217651_a(double p_217651_1_, double p_217651_3_, double p_217651_5_, double p_217651_7_, List<BeaconTileEntity.BeamSegment> p_217651_9_, long p_217651_10_) {
      ...
      for(int j = 0; j < p_217651_9_.size(); ++j) {
         BeaconTileEntity.BeamSegment beacontileentity$beamsegment = p_217651_9_.get(j);
