...
public class ShaderUniform extends ShaderDefault implements AutoCloseable {
   ...
   private void uploadInt() {
      ...
      case 0:
         GLX.glUniform1(this.uniformLocation, this.uniformIntBuffer);
         break;
      case 1:
         GLX.glUniform2(this.uniformLocation, this.uniformIntBuffer);
         break;
      case 2:
         GLX.glUniform3(this.uniformLocation, this.uniformIntBuffer);
         break;
      case 3:
         GLX.glUniform4(this.uniformLocation, this.uniformIntBuffer);
         break;
      default:
   ...
   private void uploadFloat() {
      ...
      switch(this.uniformType) {
      case 4:
         GLX.glUniform1(this.uniformLocation, this.uniformFloatBuffer);
         break;
      case 5:
         GLX.glUniform2(this.uniformLocation, this.uniformFloatBuffer);
         break;
      case 6:
         GLX.glUniform3(this.uniformLocation, this.uniformFloatBuffer);
         break;
      case 7:
         GLX.glUniform4(this.uniformLocation, this.uniformFloatBuffer);
         break;
      default:
         LOGGER.warn("Uniform.upload called, but count value ({}) is not in the range of 1 to 4. Ignoring.", (int)this.uniformCount);
      }
   ...
   private void uploadFloatMatrix() {
      ...
      switch(this.uniformType) {
      case 8:
         GLX.glUniformMatrix2(this.uniformLocation, false, this.uniformFloatBuffer);
         break;
      case 9:
         GLX.glUniformMatrix3(this.uniformLocation, false, this.uniformFloatBuffer);
         break;
      case 10:
         GLX.glUniformMatrix4(this.uniformLocation, false, this.uniformFloatBuffer);
      }
