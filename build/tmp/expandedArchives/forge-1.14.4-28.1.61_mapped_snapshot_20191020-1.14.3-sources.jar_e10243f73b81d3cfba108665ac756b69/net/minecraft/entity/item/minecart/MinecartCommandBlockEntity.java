...
public class MinecartCommandBlockEntity extends AbstractMinecartEntity {
   ...
   public class MinecartCommandLogic extends CommandBlockLogic {
      ...
      public Vec3d getPositionVector() {
         return new Vec3d(MinecartCommandBlockEntity.this.posX, MinecartCommandBlockEntity.this.posY, MinecartCommandBlockEntity.this.posZ);
      }
      ...
      public CommandSource getCommandSource() {
         return new CommandSource(this, new Vec3d(MinecartCommandBlockEntity.this.posX, MinecartCommandBlockEntity.this.posY, MinecartCommandBlockEntity.this.posZ), MinecartCommandBlockEntity.this.getPitchYaw(), this.getWorld(), 2, this.getName().getString(), MinecartCommandBlockEntity.this.getDisplayName(), this.getWorld().getServer(), MinecartCommandBlockEntity.this);
      }
   }
}