...
public abstract class HangingEntity extends Entity {
      ...
      if (!this.world.areCollisionShapesEmpty(this)) {
         ...
         for(int k = 0; k < i; ++k) {
            for(int l = 0; l < j; ++l) {
               int i1 = (i - 1) / -2;
               int j1 = (j - 1) / -2;
               blockpos$mutableblockpos.setPos(blockpos).move(direction, k + i1).move(Direction.UP, l + j1);
               BlockState blockstate = this.world.getBlockState(blockpos$mutableblockpos);
               if (net.minecraft.block.Block.func_220055_a(this.world, blockpos$mutableblockpos, this.facingDirection))
                  continue;
   ...
   public ItemEntity entityDropItem(ItemStack stack, float offsetY) {
      ItemEntity itementity = new ItemEntity(this.world, this.posX + (double)((float)this.facingDirection.getXOffset() * 0.15F), this.posY + (double)offsetY, this.posZ + (double)((float)this.facingDirection.getZOffset() * 0.15F), stack);
