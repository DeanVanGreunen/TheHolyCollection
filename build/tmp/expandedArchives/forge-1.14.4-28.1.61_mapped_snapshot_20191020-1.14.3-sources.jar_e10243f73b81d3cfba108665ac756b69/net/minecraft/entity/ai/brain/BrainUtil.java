...
public class BrainUtil {
   ...
   public static boolean isCorrectVisibleType(Brain<?> p_220623_0_, MemoryModuleType<? extends LivingEntity> p_220623_1_, EntityType<?> entityTypeIn) {
   ...
   public static void throwItemAt(LivingEntity from, ItemStack stack, LivingEntity to) {
      double d0 = from.posY - (double)0.3F + (double)from.getEyeHeight();
      ItemEntity itementity = new ItemEntity(from.world, from.posX, d0, from.posZ, stack);
