...
public class LookRandomlyGoal extends Goal {
   ...
   public void tick() {
      --this.idleTime;
      this.field_75258_a.getLookController().func_220679_a(this.field_75258_a.posX + this.lookX, this.field_75258_a.posY + (double)this.field_75258_a.getEyeHeight(), this.field_75258_a.posZ + this.lookZ);
   }
}