...
public class FollowBoatGoal extends Goal {
   ...
   public boolean shouldExecute() {
      ...
      for(BoatEntity boatentity : list) {
         if (boatentity.getControllingPassenger() != null && (MathHelper.abs(((LivingEntity)boatentity.getControllingPassenger()).moveStrafing) > 0.0F || MathHelper.abs(((LivingEntity)boatentity.getControllingPassenger()).moveForward) > 0.0F)) {
            flag = true;
            break;
         }
      }
