...
public class FleeSunGoal extends Goal {
   ...
   public boolean shouldExecute() {
      if (this.creature.getAttackTarget() != null) {
         ...
         return false;
      } else if (!this.world.isSkyLightMax(new BlockPos(this.creature.posX, this.creature.getBoundingBox().minY, this.creature.posZ))) {
         return false;
      } else {
   ...
   protected Vec3d findPossibleShelter() {
      ...
      for(int i = 0; i < 10; ++i) {
         ...
         if (!this.world.isSkyLightMax(blockpos1) && this.creature.getBlockPathWeight(blockpos1) < 0.0F) {
