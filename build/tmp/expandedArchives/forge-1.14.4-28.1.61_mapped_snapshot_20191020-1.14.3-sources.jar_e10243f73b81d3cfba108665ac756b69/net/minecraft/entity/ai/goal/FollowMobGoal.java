      ...
      if (this.followingEntity != null && !this.entity.getLeashed()) {
         ...
         if (--this.timeToRecalcPath <= 0) {
            ...
            if (!(d3 <= (double)(this.stopDistance * this.stopDistance))) {
               ...
               if (d3 <= (double)this.stopDistance || lookcontroller.getLookPosX() == this.entity.posX && lookcontroller.getLookPosY() == this.entity.posY && lookcontroller.getLookPosZ() == this.entity.posZ) {
