...
public class LookController {
   ...
   public void setLookPositionWithEntity(Entity entityIn, float deltaYaw, float deltaPitch) {
      this.setLookPosition(entityIn.posX, func_220676_b(entityIn), entityIn.posZ, deltaYaw, deltaPitch);
   }
   ...
   private static double func_220676_b(Entity p_220676_0_) {
      return p_220676_0_ instanceof LivingEntity ? p_220676_0_.posY + (double)p_220676_0_.getEyeHeight() : (p_220676_0_.getBoundingBox().minY + p_220676_0_.getBoundingBox().maxY) / 2.0D;
   }
}