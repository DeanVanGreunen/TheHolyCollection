...
public class FindWaterGoal extends Goal {
   ...
   public void startExecuting() {
      ...
      for(BlockPos blockpos1 : BlockPos.getAllInBoxMutable(MathHelper.floor(this.field_205152_a.posX - 2.0D), MathHelper.floor(this.field_205152_a.posY - 2.0D), MathHelper.floor(this.field_205152_a.posZ - 2.0D), MathHelper.floor(this.field_205152_a.posX + 2.0D), MathHelper.floor(this.field_205152_a.posY), MathHelper.floor(this.field_205152_a.posZ + 2.0D))) {
