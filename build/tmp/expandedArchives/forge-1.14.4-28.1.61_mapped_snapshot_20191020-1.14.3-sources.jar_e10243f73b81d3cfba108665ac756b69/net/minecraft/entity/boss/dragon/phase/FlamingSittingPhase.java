...
public class FlamingSittingPhase extends SittingPhase {
   ...
   public void clientTick() {
      ...
      if (this.flameTicks % 2 == 0 && this.flameTicks < 10) {
         ...
         double d1 = this.dragon.dragonPartHead.posY + (double)(this.dragon.dragonPartHead.getHeight() / 2.0F);
   ...
   public void serverTick() {
      ...
      if (this.flameTicks >= 200) {
         ...
         double d2 = this.dragon.dragonPartHead.posY + (double)(this.dragon.dragonPartHead.getHeight() / 2.0F);
