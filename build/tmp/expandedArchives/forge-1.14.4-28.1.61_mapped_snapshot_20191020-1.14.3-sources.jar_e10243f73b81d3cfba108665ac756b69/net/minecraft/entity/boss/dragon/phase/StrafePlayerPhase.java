      ...
      if (this.attackTarget == null) {
         ...
         if (this.attackTarget.getDistanceSq(this.dragon) < 4096.0D) {
            if (this.dragon.canEntityBeSeen(this.attackTarget)) {
               ...
               Vec3d vec3d = (new Vec3d((double)MathHelper.sin(this.dragon.rotationYaw * ((float)Math.PI / 180F)), 0.0D, (double)(-MathHelper.cos(this.dragon.rotationYaw * ((float)Math.PI / 180F))))).normalize();
               ...
               if (this.fireballCharge >= 5 && f >= 0.0F && f < 10.0F) {
                  ...
                  double d7 = this.dragon.dragonPartHead.posY + (double)(this.dragon.dragonPartHead.getHeight() / 2.0F) + 0.5D;
                  double d8 = this.dragon.dragonPartHead.posZ - vec3d2.z * 1.0D;
                  double d9 = this.attackTarget.posX - d6;
                  double d10 = this.attackTarget.posY + (double)(this.attackTarget.getHeight() / 2.0F) - (d7 + (double)(this.dragon.dragonPartHead.getHeight() / 2.0F));
