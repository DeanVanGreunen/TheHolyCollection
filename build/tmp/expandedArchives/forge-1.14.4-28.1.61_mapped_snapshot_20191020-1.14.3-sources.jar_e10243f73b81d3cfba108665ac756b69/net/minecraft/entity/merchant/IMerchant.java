...
public interface IMerchant {
   ...
   default void func_213707_a(PlayerEntity player, ITextComponent p_213707_2_, int level) {
      ...
      if (optionalint.isPresent()) {
         ...
         if (!merchantoffers.isEmpty()) {
            player.func_213818_a(optionalint.getAsInt(), merchantoffers, level, this.getXp(), this.func_213705_dZ(), this.func_223340_ej());
         }
      }
