...
public abstract class MonsterEntity extends CreatureEntity implements IMob {
   ...
   public static boolean func_223325_c(EntityType<? extends MonsterEntity> type, IWorld worldIn, SpawnReason reason, BlockPos pos, Random randomIn) {
      return worldIn.getDifficulty() != Difficulty.PEACEFUL && isValidLightLevel(worldIn, pos, randomIn) && func_223315_a(type, worldIn, reason, pos, randomIn);
   }
   ...
   public static boolean func_223324_d(EntityType<? extends MonsterEntity> type, IWorld worldIn, SpawnReason reason, BlockPos pos, Random randomIn) {
      return worldIn.getDifficulty() != Difficulty.PEACEFUL && func_223315_a(type, worldIn, reason, pos, randomIn);
   }
