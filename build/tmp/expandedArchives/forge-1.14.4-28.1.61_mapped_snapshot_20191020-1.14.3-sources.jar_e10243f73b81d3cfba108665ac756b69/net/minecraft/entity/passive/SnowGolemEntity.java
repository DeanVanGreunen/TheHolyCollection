...
public class SnowGolemEntity extends GolemEntity implements IRangedAttackMob, net.minecraftforge.common.IShearable {
   ...
   public void livingTick() {
      ...
      if (!this.world.isRemote) {
         ...
         if (this.world.getBiome(new BlockPos(i, 0, k)).func_225486_c(new BlockPos(i, j, k)) > 1.0F) {
         ...
         for(int l = 0; l < 4; ++l) {
            ...
            if (this.world.isAirBlock(blockpos) && this.world.getBiome(blockpos).func_225486_c(blockpos) < 0.8F && blockstate.isValidPosition(this.world, blockpos)) {
