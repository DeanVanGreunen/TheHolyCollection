...
public class CatEntity extends TameableEntity {
   ...
   public ResourceLocation getCatTypeName() {
      return field_213425_bD.get(this.getCatType());
   }
   ...
   static class MorningGiftGoal extends Goal {
      ...
      private void func_220804_h() {
         ...
         blockpos$mutableblockpos.setPos(this.cat);
         this.cat.attemptTeleport((double)(blockpos$mutableblockpos.getX() + random.nextInt(11) - 5), (double)(blockpos$mutableblockpos.getY() + random.nextInt(5) - 2), (double)(blockpos$mutableblockpos.getZ() + random.nextInt(11) - 5), false);
         blockpos$mutableblockpos.setPos(this.cat);
         ...
         LootContext.Builder lootcontext$builder = (new LootContext.Builder((ServerWorld)this.cat.world)).withParameter(LootParameters.POSITION, blockpos$mutableblockpos).withParameter(LootParameters.THIS_ENTITY, this.cat).withRandom(random);

         for(ItemStack itemstack : loottable.generate(lootcontext$builder.build(LootParameterSets.GIFT))) {
            this.cat.world.addEntity(new ItemEntity(this.cat.world, (double)((float)blockpos$mutableblockpos.getX() - MathHelper.sin(this.cat.renderYawOffset * ((float)Math.PI / 180F))), (double)blockpos$mutableblockpos.getY(), (double)((float)blockpos$mutableblockpos.getZ() + MathHelper.cos(this.cat.renderYawOffset * ((float)Math.PI / 180F))), itemstack));
         }
   ...
   static class TemptGoal extends net.minecraft.entity.ai.goal.TemptGoal {
      ...
      public TemptGoal(CatEntity catIn, double speedIn, Ingredient temptItemsIn, boolean p_i50438_5_) {
         super(catIn, speedIn, temptItemsIn, p_i50438_5_);
         this.cat = catIn;
      }
