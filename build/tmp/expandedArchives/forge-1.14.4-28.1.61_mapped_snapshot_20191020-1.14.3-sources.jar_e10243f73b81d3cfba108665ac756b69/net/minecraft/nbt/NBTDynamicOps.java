...
public class NBTDynamicOps implements DynamicOps<INBT> {
   ...
   public INBT createString(String p_createString_1_) {
      return new StringNBT(p_createString_1_);
   }
