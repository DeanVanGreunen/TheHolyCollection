...
public class BlockTagsProvider extends TagsProvider<Block> {
   ...
   protected void registerTags() {
      ...
      this.getBuilder(BlockTags.DIRT_LIKE).add(Blocks.DIRT).add(Blocks.GRASS_BLOCK).add(Blocks.PODZOL).add(Blocks.COARSE_DIRT).add(Blocks.MYCELIUM);
      this.getBuilder(BlockTags.BAMBOO_PLANTABLE_ON).add(Blocks.BAMBOO).add(Blocks.BAMBOO_SAPLING).add(Blocks.GRAVEL).add(BlockTags.SAND).add(BlockTags.DIRT_LIKE);
