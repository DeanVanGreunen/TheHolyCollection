...
public class ChanneledLightningTrigger implements ICriterionTrigger<ChanneledLightningTrigger.Instance> {
   ...
   public void trigger(ServerPlayerEntity player, Collection<? extends Entity> entityTriggered) {
      ChanneledLightningTrigger.Listeners channeledlightningtrigger$listeners = this.listeners.get(player.getAdvancements());
      if (channeledlightningtrigger$listeners != null) {
         channeledlightningtrigger$listeners.trigger(player, entityTriggered);
      }
   ...
   static class Listeners {
      ...
      public void trigger(ServerPlayerEntity p_204846_1_, Collection<? extends Entity> p_204846_2_) {
         ...
         for(ICriterionTrigger.Listener<ChanneledLightningTrigger.Instance> listener : this.listeners) {
            if (listener.getCriterionInstance().test(p_204846_1_, p_204846_2_)) {
               if (list == null) {
