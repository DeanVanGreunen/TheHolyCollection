...
public class ConsumeItemTrigger implements ICriterionTrigger<ConsumeItemTrigger.Instance> {
   ...
   public static class Instance extends CriterionInstance {
      ...
      public static ConsumeItemTrigger.Instance forItem(IItemProvider p_203913_0_) {
         return new ConsumeItemTrigger.Instance(new ItemPredicate((Tag<Item>)null, p_203913_0_.asItem(), MinMaxBounds.IntBound.UNBOUNDED, MinMaxBounds.IntBound.UNBOUNDED, new EnchantmentPredicate[0], (Potion)null, NBTPredicate.ANY));
      }
