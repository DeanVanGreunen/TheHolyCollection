...
public class ItemPredicate {
   ...
   public boolean test(ItemStack item) {
      if (this == ANY) {
         ...
         if (this.potion != null && this.potion != potion) {
            return false;
         } else {
            return true;
         }
   ...
   public static ItemPredicate deserialize(@Nullable JsonElement element) {
      if (element != null && !element.isJsonNull()) {
         ...
         if (jsonobject.has("data")) {
            ...
            return new ItemPredicate(tag, item, minmaxbounds$intbound, minmaxbounds$intbound1, aenchantmentpredicate, potion, nbtpredicate);
         }
      } else {
         return ANY;
      }
