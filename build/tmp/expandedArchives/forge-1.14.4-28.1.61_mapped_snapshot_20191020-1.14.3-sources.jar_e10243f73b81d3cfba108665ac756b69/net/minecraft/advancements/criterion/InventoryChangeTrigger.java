...
public class InventoryChangeTrigger implements ICriterionTrigger<InventoryChangeTrigger.Instance> {
   ...
   public static class Instance extends CriterionInstance {
      ...
      public static InventoryChangeTrigger.Instance forItems(IItemProvider... p_203922_0_) {
         ...
         for(int i = 0; i < p_203922_0_.length; ++i) {
            aitempredicate[i] = new ItemPredicate((Tag<Item>)null, p_203922_0_[i].asItem(), MinMaxBounds.IntBound.UNBOUNDED, MinMaxBounds.IntBound.UNBOUNDED, new EnchantmentPredicate[0], (Potion)null, NBTPredicate.ANY);
         }
   ...
   static class Listeners {
      ...
      public void trigger(PlayerInventory inventory) {
