...
public class FishingRodHookedTrigger implements ICriterionTrigger<FishingRodHookedTrigger.Instance> {
   ...
   static class Listeners {
      ...
      public void trigger(ServerPlayerEntity p_204859_1_, ItemStack p_204859_2_, FishingBobberEntity p_204859_3_, Collection<ItemStack> p_204859_4_) {
         ...
         for(ICriterionTrigger.Listener<FishingRodHookedTrigger.Instance> listener : this.listeners) {
            if (listener.getCriterionInstance().test(p_204859_1_, p_204859_2_, p_204859_3_, p_204859_4_)) {
               if (list == null) {
