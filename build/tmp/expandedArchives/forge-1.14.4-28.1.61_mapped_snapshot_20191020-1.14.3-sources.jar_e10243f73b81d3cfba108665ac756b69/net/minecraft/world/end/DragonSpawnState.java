         ...
         if (flag || flag1) {
            ...
            if (j < list.size()) {
               ...
               if (flag) {
                  ...
                  Feature.END_SPIKE.place(worldIn, worldIn.getChunkProvider().getChunkGenerator(), new Random(), new BlockPos(endspikefeature$endspike.getCenterX(), 45, endspikefeature$endspike.getCenterZ()), endspikefeatureconfig);
               }
            } else if (flag) {
      ...
      public void process(ServerWorld worldIn, DragonFightManager manager, List<EnderCrystalEntity> crystals, int ticks, BlockPos pos) {
         if (ticks >= 100) {
            ...
            for(EnderCrystalEntity endercrystalentity : crystals) {
               ...
               worldIn.createExplosion(endercrystalentity, endercrystalentity.posX, endercrystalentity.posY, endercrystalentity.posZ, 6.0F, Explosion.Mode.NONE);
