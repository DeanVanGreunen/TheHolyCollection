...
public class FortressPieces {
   ...
   public static class Corridor extends FortressPieces.Piece {
      ...
      public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos chunkPosIn) {
         ...
         this.fillWithBlocks(worldIn, structureBoundingBoxIn, 4, 3, 1, 4, 4, 1, blockstate1, blockstate1, false);
         this.fillWithBlocks(worldIn, structureBoundingBoxIn, 4, 3, 3, 4, 4, 3, blockstate1, blockstate1, false);
         ...
         this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, 3, 4, 1, 4, 4, blockstate, blockstate, false);
         this.fillWithBlocks(worldIn, structureBoundingBoxIn, 3, 3, 4, 3, 4, 4, blockstate, blockstate, false);
   ...
   public static class Corridor2 extends FortressPieces.Piece {
      ...
      public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos chunkPosIn) {
         ...
         this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 3, 1, 0, 4, 1, blockstate1, blockstate1, false);
         this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 3, 3, 0, 4, 3, blockstate1, blockstate1, false);
   ...
   public static class Corridor3 extends FortressPieces.Piece {
      ...
      public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos chunkPosIn) {
         ...
         for(int i = 0; i <= 9; ++i) {
            ...
            if (i <= 6) {
               this.setBlockState(worldIn, blockstate, 1, j + 1, i, structureBoundingBoxIn);
               this.setBlockState(worldIn, blockstate, 2, j + 1, i, structureBoundingBoxIn);
               this.setBlockState(worldIn, blockstate, 3, j + 1, i, structureBoundingBoxIn);
            }
            ...
            if ((i & 1) == 0) {
               this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, j + 2, i, 0, j + 3, i, blockstate1, blockstate1, false);
               this.fillWithBlocks(worldIn, structureBoundingBoxIn, 4, j + 2, i, 4, j + 3, i, blockstate1, blockstate1, false);
            }
   ...
   public static class Corridor4 extends FortressPieces.Piece {
      ...
      public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos chunkPosIn) {
         ...
         this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, 3, 0, 1, 4, 0, blockstate1, blockstate1, false);
         this.fillWithBlocks(worldIn, structureBoundingBoxIn, 7, 3, 0, 7, 4, 0, blockstate1, blockstate1, false);
         ...
         this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, 3, 8, 7, 3, 8, blockstate1, blockstate1, false);
         ...
         this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 3, 6, 0, 3, 7, blockstate, blockstate, false);
         this.fillWithBlocks(worldIn, structureBoundingBoxIn, 8, 3, 6, 8, 3, 7, blockstate, blockstate, false);
         ...
         this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, 4, 5, 1, 5, 5, blockstate1, blockstate1, false);
         this.fillWithBlocks(worldIn, structureBoundingBoxIn, 7, 4, 5, 7, 5, 5, blockstate1, blockstate1, false);
   ...
   public static class Corridor5 extends FortressPieces.Piece {
      ...
      public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos chunkPosIn) {
         ...
         this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 2, 0, 0, 5, 4, Blocks.NETHER_BRICKS.getDefaultState(), Blocks.NETHER_BRICKS.getDefaultState(), false);
         this.fillWithBlocks(worldIn, structureBoundingBoxIn, 4, 2, 0, 4, 5, 4, Blocks.NETHER_BRICKS.getDefaultState(), Blocks.NETHER_BRICKS.getDefaultState(), false);
         this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 3, 1, 0, 4, 1, blockstate, blockstate, false);
         this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 3, 3, 0, 4, 3, blockstate, blockstate, false);
         this.fillWithBlocks(worldIn, structureBoundingBoxIn, 4, 3, 1, 4, 4, 1, blockstate, blockstate, false);
         this.fillWithBlocks(worldIn, structureBoundingBoxIn, 4, 3, 3, 4, 4, 3, blockstate, blockstate, false);
         this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 6, 0, 4, 6, 4, Blocks.NETHER_BRICKS.getDefaultState(), Blocks.NETHER_BRICKS.getDefaultState(), false);
   ...
   public static class Crossing extends FortressPieces.Piece {
      ...
      public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos chunkPosIn) {
         ...
         this.fillWithBlocks(worldIn, structureBoundingBoxIn, 2, 5, 0, 4, 5, 0, blockstate, blockstate, false);
         ...
         this.fillWithBlocks(worldIn, structureBoundingBoxIn, 2, 5, 6, 4, 5, 6, blockstate, blockstate, false);
         ...
         this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 5, 2, 0, 5, 4, blockstate1, blockstate1, false);
         ...
         this.fillWithBlocks(worldIn, structureBoundingBoxIn, 6, 5, 2, 6, 5, 4, blockstate1, blockstate1, false);
   ...
   public static class Entrance extends FortressPieces.Piece {
      ...
      public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos chunkPosIn) {
         ...
         for(int i = 1; i <= 11; i += 2) {
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, i, 10, 0, i, 11, 0, blockstate, blockstate, false);
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, i, 10, 12, i, 11, 12, blockstate, blockstate, false);
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 10, i, 0, 11, i, blockstate1, blockstate1, false);
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 12, 10, i, 12, 11, i, blockstate1, blockstate1, false);
            ...
            if (i != 11) {
               this.setBlockState(worldIn, blockstate, i + 1, 13, 0, structureBoundingBoxIn);
               this.setBlockState(worldIn, blockstate, i + 1, 13, 12, structureBoundingBoxIn);
               this.setBlockState(worldIn, blockstate1, 0, 13, i + 1, structureBoundingBoxIn);
               this.setBlockState(worldIn, blockstate1, 12, 13, i + 1, structureBoundingBoxIn);
            }
         }
         ...
         for(int k = 3; k <= 9; k += 2) {
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, 7, k, 1, 8, k, blockstate1.with(FenceBlock.WEST, Boolean.valueOf(true)), blockstate1.with(FenceBlock.WEST, Boolean.valueOf(true)), false);
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 11, 7, k, 11, 8, k, blockstate1.with(FenceBlock.EAST, Boolean.valueOf(true)), blockstate1.with(FenceBlock.EAST, Boolean.valueOf(true)), false);
         }
   ...
   public static class NetherStalkRoom extends FortressPieces.Piece {
      ...
      public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos chunkPosIn) {
         ...
         for(int j1 = 3; j1 <= 9; j1 += 2) {
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, 7, j1, 1, 8, j1, blockstate2, blockstate2, false);
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 11, 7, j1, 11, 8, j1, blockstate3, blockstate3, false);
         }
         ...
         for(int j = 0; j <= 6; ++j) {
            ...
            for(int l = 5; l <= 7; ++l) {
               this.setBlockState(worldIn, blockstate4, l, 5 + j, k, structureBoundingBoxIn);
            }
         ...
         for(int k1 = 5; k1 <= 7; ++k1) {
            this.setBlockState(worldIn, blockstate4, k1, 12, 11, structureBoundingBoxIn);
         }

         this.fillWithBlocks(worldIn, structureBoundingBoxIn, 5, 6, 7, 5, 7, 7, blockstate3, blockstate3, false);
         this.fillWithBlocks(worldIn, structureBoundingBoxIn, 7, 6, 7, 7, 7, 7, blockstate2, blockstate2, false);
         ...
         this.setBlockState(worldIn, blockstate6, 4, 5, 2, structureBoundingBoxIn);
         this.setBlockState(worldIn, blockstate6, 4, 5, 3, structureBoundingBoxIn);
         this.setBlockState(worldIn, blockstate6, 4, 5, 9, structureBoundingBoxIn);
         this.setBlockState(worldIn, blockstate6, 4, 5, 10, structureBoundingBoxIn);
         this.setBlockState(worldIn, blockstate5, 8, 5, 2, structureBoundingBoxIn);
         this.setBlockState(worldIn, blockstate5, 8, 5, 3, structureBoundingBoxIn);
         this.setBlockState(worldIn, blockstate5, 8, 5, 9, structureBoundingBoxIn);
         this.setBlockState(worldIn, blockstate5, 8, 5, 10, structureBoundingBoxIn);
   ...
   public static class Stairs extends FortressPieces.Piece {
      ...
      public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos chunkPosIn) {
         ...
         BlockState blockstate = Blocks.NETHER_BRICK_FENCE.getDefaultState().with(FenceBlock.WEST, Boolean.valueOf(true)).with(FenceBlock.EAST, Boolean.valueOf(true));
         BlockState blockstate1 = Blocks.NETHER_BRICK_FENCE.getDefaultState().with(FenceBlock.NORTH, Boolean.valueOf(true)).with(FenceBlock.SOUTH, Boolean.valueOf(true));
         this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 3, 2, 0, 5, 4, blockstate1, blockstate1, false);
         this.fillWithBlocks(worldIn, structureBoundingBoxIn, 6, 3, 2, 6, 5, 2, blockstate1, blockstate1, false);
         this.fillWithBlocks(worldIn, structureBoundingBoxIn, 6, 3, 4, 6, 5, 4, blockstate1, blockstate1, false);
   ...
   public static class Straight extends FortressPieces.Piece {
      ...
      public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos chunkPosIn) {
         ...
         this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 1, 1, 0, 4, 1, blockstate2, blockstate2, false);
         this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 3, 4, 0, 4, 4, blockstate2, blockstate2, false);
         this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 3, 14, 0, 4, 14, blockstate2, blockstate2, false);
         this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 1, 17, 0, 4, 17, blockstate2, blockstate2, false);
         this.fillWithBlocks(worldIn, structureBoundingBoxIn, 4, 1, 1, 4, 4, 1, blockstate, blockstate, false);
         this.fillWithBlocks(worldIn, structureBoundingBoxIn, 4, 3, 4, 4, 4, 4, blockstate, blockstate, false);
         this.fillWithBlocks(worldIn, structureBoundingBoxIn, 4, 3, 14, 4, 4, 14, blockstate, blockstate, false);
         this.fillWithBlocks(worldIn, structureBoundingBoxIn, 4, 1, 17, 4, 4, 17, blockstate, blockstate, false);
         return true;
      }
   }
   ...
   public static class Throne extends FortressPieces.Piece {
      ...
      public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos chunkPosIn) {
         ...
         this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 6, 4, 0, 6, 7, blockstate1, blockstate1, false);
         this.fillWithBlocks(worldIn, structureBoundingBoxIn, 6, 6, 4, 6, 6, 7, blockstate1, blockstate1, false);
         ...
         this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, 6, 8, 5, 6, 8, blockstate, blockstate, false);
         ...
         this.fillWithBlocks(worldIn, structureBoundingBoxIn, 2, 7, 8, 4, 7, 8, blockstate, blockstate, false);
         ...
         this.setBlockState(worldIn, blockstate, 3, 8, 8, structureBoundingBoxIn);
