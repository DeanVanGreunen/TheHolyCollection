...
public class Template {
   ...
   public static List<Template.EntityInfo> processEntityInfos(@Nullable Template template, IWorld worldIn, BlockPos offsetPos, PlacementSettings placementSettingsIn, List<Template.EntityInfo> blockInfos) {
      ...
      for(Template.EntityInfo entityInfo : blockInfos) {
         ...
         Template.EntityInfo entityInfo1 = new Template.EntityInfo(pos, blockpos, entityInfo.nbt);

         for(Iterator<StructureProcessor> iterator = placementSettingsIn.getProcessors().iterator(); entityInfo1 != null && iterator.hasNext(); entityInfo1 = iterator.next().processEntity(worldIn, offsetPos, entityInfo, entityInfo1, placementSettingsIn, template)) {
            ;
         }
