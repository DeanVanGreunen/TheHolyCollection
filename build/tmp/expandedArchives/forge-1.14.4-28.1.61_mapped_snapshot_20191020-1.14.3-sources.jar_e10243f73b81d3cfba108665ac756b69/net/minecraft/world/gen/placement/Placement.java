...
public abstract class Placement<DC extends IPlacementConfig> extends net.minecraftforge.registries.ForgeRegistryEntry<Placement<?>> {
   ...
   public static final Placement<LakeChanceConfig> LAVA_LAKE = register("lava_lake", new LakeLava(LakeChanceConfig::deserialize));
   public static final Placement<LakeChanceConfig> WATER_LAKE = register("water_lake", new LakeWater(LakeChanceConfig::deserialize));
   public static final Placement<DungeonRoomConfig> DUNGEONS = register("dungeons", new DungeonRoom(DungeonRoomConfig::deserialize));
   ...
   protected <FC extends IFeatureConfig> boolean place(IWorld worldIn, ChunkGenerator<? extends GenerationSettings> p_214998_2_, Random random, BlockPos pos, DC p_214998_5_, ConfiguredFeature<FC> p_214998_6_) {
