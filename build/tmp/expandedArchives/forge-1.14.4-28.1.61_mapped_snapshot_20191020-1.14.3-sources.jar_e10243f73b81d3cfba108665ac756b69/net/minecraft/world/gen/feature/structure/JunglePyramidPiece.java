...
public class JunglePyramidPiece extends ScatteredStructurePiece {
   ...
   public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos chunkPosIn) {
      if (!this.isInsideBounds(worldIn, structureBoundingBoxIn, 0)) {
         ...
         this.setBlockState(worldIn, blockstate1, 5, 9, 6, structureBoundingBoxIn);
         this.setBlockState(worldIn, blockstate1, 6, 9, 6, structureBoundingBoxIn);
         this.setBlockState(worldIn, blockstate, 5, 9, 8, structureBoundingBoxIn);
         this.setBlockState(worldIn, blockstate, 6, 9, 8, structureBoundingBoxIn);
         this.setBlockState(worldIn, blockstate1, 4, 0, 0, structureBoundingBoxIn);
         this.setBlockState(worldIn, blockstate1, 5, 0, 0, structureBoundingBoxIn);
         this.setBlockState(worldIn, blockstate1, 6, 0, 0, structureBoundingBoxIn);
         this.setBlockState(worldIn, blockstate1, 7, 0, 0, structureBoundingBoxIn);
         this.setBlockState(worldIn, blockstate1, 4, 1, 8, structureBoundingBoxIn);
         this.setBlockState(worldIn, blockstate1, 4, 2, 9, structureBoundingBoxIn);
         this.setBlockState(worldIn, blockstate1, 4, 3, 10, structureBoundingBoxIn);
         this.setBlockState(worldIn, blockstate1, 7, 1, 8, structureBoundingBoxIn);
         this.setBlockState(worldIn, blockstate1, 7, 2, 9, structureBoundingBoxIn);
         this.setBlockState(worldIn, blockstate1, 7, 3, 10, structureBoundingBoxIn);
         ...
         this.setBlockState(worldIn, blockstate3, 4, 4, 5, structureBoundingBoxIn);
         this.setBlockState(worldIn, blockstate4, 7, 4, 5, structureBoundingBoxIn);

         for(int k = 0; k < 4; ++k) {
            this.setBlockState(worldIn, blockstate, 5, 0 - k, 6 + k, structureBoundingBoxIn);
            this.setBlockState(worldIn, blockstate, 6, 0 - k, 6 + k, structureBoundingBoxIn);
         ...
         this.setBlockState(worldIn, blockstate5, 5, -3, 6, structureBoundingBoxIn);
         this.setBlockState(worldIn, blockstate5, 5, -3, 5, structureBoundingBoxIn);
         this.setBlockState(worldIn, blockstate5, 5, -3, 4, structureBoundingBoxIn);
         this.setBlockState(worldIn, blockstate5, 5, -3, 3, structureBoundingBoxIn);
         this.setBlockState(worldIn, blockstate5, 5, -3, 2, structureBoundingBoxIn);
         this.setBlockState(worldIn, Blocks.REDSTONE_WIRE.getDefaultState().with(RedstoneWireBlock.NORTH, RedstoneSide.SIDE).with(RedstoneWireBlock.WEST, RedstoneSide.SIDE), 5, -3, 1, structureBoundingBoxIn);
         this.setBlockState(worldIn, Blocks.REDSTONE_WIRE.getDefaultState().with(RedstoneWireBlock.EAST, RedstoneSide.SIDE), 4, -3, 1, structureBoundingBoxIn);
         this.setBlockState(worldIn, Blocks.MOSSY_COBBLESTONE.getDefaultState(), 3, -3, 1, structureBoundingBoxIn);
         if (!this.placedTrap1) {
            this.placedTrap1 = this.createDispenser(worldIn, structureBoundingBoxIn, randomIn, 3, -2, 1, Direction.NORTH, LootTables.CHESTS_JUNGLE_TEMPLE_DISPENSER);
         }
         ...
         this.setBlockState(worldIn, Blocks.REDSTONE_WIRE.getDefaultState().with(RedstoneWireBlock.WEST, RedstoneSide.SIDE).with(RedstoneWireBlock.SOUTH, RedstoneSide.SIDE), 9, -3, 6, structureBoundingBoxIn);
         this.setBlockState(worldIn, Blocks.REDSTONE_WIRE.getDefaultState().with(RedstoneWireBlock.NORTH, RedstoneSide.SIDE).with(RedstoneWireBlock.SOUTH, RedstoneSide.UP), 9, -3, 5, structureBoundingBoxIn);
         this.setBlockState(worldIn, Blocks.MOSSY_COBBLESTONE.getDefaultState(), 9, -3, 4, structureBoundingBoxIn);
         this.setBlockState(worldIn, Blocks.REDSTONE_WIRE.getDefaultState().with(RedstoneWireBlock.NORTH, RedstoneSide.SIDE), 9, -2, 4, structureBoundingBoxIn);
         if (!this.placedTrap2) {
            this.placedTrap2 = this.createDispenser(worldIn, structureBoundingBoxIn, randomIn, 9, -2, 3, Direction.WEST, LootTables.CHESTS_JUNGLE_TEMPLE_DISPENSER);
         }
         ...
         if (!this.placedMainChest) {
            this.placedMainChest = this.generateChest(worldIn, structureBoundingBoxIn, randomIn, 8, -3, 3, LootTables.CHESTS_JUNGLE_TEMPLE);
         }
         ...
         this.setBlockState(worldIn, blockstate2, 8, -2, 12, structureBoundingBoxIn);
         this.setBlockState(worldIn, blockstate2, 9, -2, 12, structureBoundingBoxIn);
         this.setBlockState(worldIn, blockstate2, 10, -2, 12, structureBoundingBoxIn);
         ...
         if (!this.placedHiddenChest) {
            this.placedHiddenChest = this.generateChest(worldIn, structureBoundingBoxIn, randomIn, 9, -3, 10, LootTables.CHESTS_JUNGLE_TEMPLE);
         }
