...
public class PlacementSettings {
   ...
   public List<Template.BlockInfo> func_204764_a(List<List<Template.BlockInfo>> p_204764_1_, @Nullable BlockPos pos) {
      ...
      if (this.field_204766_l != null && this.field_204766_l >= 0 && this.field_204766_l < p_204764_1_.size()) {
         ...
         this.field_204766_l = this.getRandom(pos).nextInt(p_204764_1_.size());
         return p_204764_1_.get(this.field_204766_l);
      }
   }
