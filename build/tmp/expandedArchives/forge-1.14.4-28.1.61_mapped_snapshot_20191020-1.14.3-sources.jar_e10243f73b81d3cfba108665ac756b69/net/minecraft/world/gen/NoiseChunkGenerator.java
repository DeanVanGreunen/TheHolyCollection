...
public abstract class NoiseChunkGenerator<T extends GenerationSettings> extends ChunkGenerator<T> {
   ...
   public NoiseChunkGenerator(IWorld worldIn, BiomeProvider biomeProviderIn, int p_i49931_3_, int verticalNoiseGranularityIn, int p_i49931_5_, T settingsIn, boolean usePerlin) {
