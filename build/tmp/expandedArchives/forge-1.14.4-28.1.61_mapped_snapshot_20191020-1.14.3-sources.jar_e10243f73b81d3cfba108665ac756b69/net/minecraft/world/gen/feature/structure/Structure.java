...
public abstract class Structure<C extends IFeatureConfig> extends Feature<C> {
               ...
               for(int i1 = -k; i1 <= k; ++i1) {
                  ...
                  if (flag || flag1) {
                     ...
                     if (structurestart != null && structurestart.isValid()) {
                        if (p_211405_5_ && structurestart.isRefCountBelowMax()) {
   ...
   public abstract boolean hasStartAt(ChunkGenerator<?> chunkGen, Random rand, int chunkPosX, int chunkPosZ);
   ...
   public interface IStartFactory {
      StructureStart create(Structure<?> p_create_1_, int p_create_2_, int p_create_3_, Biome p_create_4_, MutableBoundingBox p_create_5_, int p_create_6_, long p_create_7_);
   }
}