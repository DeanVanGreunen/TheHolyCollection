   ...
   public static class Piece extends TemplateStructurePiece {
      ...
      private int func_204035_a(BlockPos templatePos, IBlockReader blockReaderIn, BlockPos templateTransformedPos) {
         ...
         for(BlockPos blockpos : BlockPos.getAllInBoxMutable(templatePos, templateTransformedPos)) {
            ...
            BlockState blockstate = blockReaderIn.getBlockState(blockpos$mutableblockpos);

            for(IFluidState ifluidstate = blockReaderIn.getFluidState(blockpos$mutableblockpos); (blockstate.isAir() || ifluidstate.isTagged(FluidTags.WATER) || blockstate.getBlock().isIn(BlockTags.ICE)) && k1 > 1; ifluidstate = blockReaderIn.getFluidState(blockpos$mutableblockpos)) {
               --k1;
               blockpos$mutableblockpos.setPos(i1, k1, j1);
               blockstate = blockReaderIn.getBlockState(blockpos$mutableblockpos);
            }
