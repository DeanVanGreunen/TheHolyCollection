...
public class OceanMonumentPieces {
   public static class DoubleXRoom extends OceanMonumentPieces.Piece {
      ...
      public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos chunkPosIn) {
         ...
         if (this.roomDefinition.index / 25 > 0) {
            this.generateDefaultFloor(worldIn, structureBoundingBoxIn, 8, 0, oceanmonumentpieces$roomdefinition.hasOpening[Direction.DOWN.getIndex()]);
            this.generateDefaultFloor(worldIn, structureBoundingBoxIn, 0, 0, oceanmonumentpieces$roomdefinition1.hasOpening[Direction.DOWN.getIndex()]);
         }
   ...
   public static class DoubleXYRoom extends OceanMonumentPieces.Piece {
      ...
      public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos chunkPosIn) {
         ...
         for(int i = 1; i <= 7; ++i) {
            ...
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, i, 0, 0, i, 7, blockstate, blockstate, false);
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 15, i, 0, 15, i, 7, blockstate, blockstate, false);
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, i, 0, 15, i, 0, blockstate, blockstate, false);
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, i, 7, 14, i, 7, blockstate, blockstate, false);
         }
   ...
   public static class DoubleYRoom extends OceanMonumentPieces.Piece {
      ...
      public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos chunkPosIn) {
         if (this.roomDefinition.index / 25 > 0) {
            this.generateDefaultFloor(worldIn, structureBoundingBoxIn, 0, 0, this.roomDefinition.hasOpening[Direction.DOWN.getIndex()]);
         }
   ...
   public static class DoubleYZRoom extends OceanMonumentPieces.Piece {
      ...
      public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos chunkPosIn) {
         ...
         if (this.roomDefinition.index / 25 > 0) {
            this.generateDefaultFloor(worldIn, structureBoundingBoxIn, 0, 8, oceanmonumentpieces$roomdefinition.hasOpening[Direction.DOWN.getIndex()]);
            this.generateDefaultFloor(worldIn, structureBoundingBoxIn, 0, 0, oceanmonumentpieces$roomdefinition1.hasOpening[Direction.DOWN.getIndex()]);
         }
         ...
         for(int i = 1; i <= 7; ++i) {
            ...
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, i, 0, 0, i, 15, blockstate, blockstate, false);
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 7, i, 0, 7, i, 15, blockstate, blockstate, false);
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, i, 0, 6, i, 0, blockstate, blockstate, false);
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, i, 15, 6, i, 15, blockstate, blockstate, false);
         }
         ...
         for(int j = 1; j <= 7; ++j) {
            ...
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 3, j, 7, 4, j, 8, blockstate1, blockstate1, false);
         }
         ...
         if (oceanmonumentpieces$roomdefinition1.hasOpening[Direction.EAST.getIndex()]) {
            this.makeOpening(worldIn, structureBoundingBoxIn, 7, 1, 3, 7, 2, 4);
         }
         ...
         if (oceanmonumentpieces$roomdefinition.hasOpening[Direction.NORTH.getIndex()]) {
            this.makeOpening(worldIn, structureBoundingBoxIn, 3, 1, 15, 4, 2, 15);
         }

         if (oceanmonumentpieces$roomdefinition.hasOpening[Direction.WEST.getIndex()]) {
            this.makeOpening(worldIn, structureBoundingBoxIn, 0, 1, 11, 0, 2, 12);
         }

         if (oceanmonumentpieces$roomdefinition.hasOpening[Direction.EAST.getIndex()]) {
            this.makeOpening(worldIn, structureBoundingBoxIn, 7, 1, 11, 7, 2, 12);
         }
         ...
         if (oceanmonumentpieces$roomdefinition3.hasOpening[Direction.EAST.getIndex()]) {
            this.makeOpening(worldIn, structureBoundingBoxIn, 7, 5, 3, 7, 6, 4);
         ...
         if (oceanmonumentpieces$roomdefinition2.hasOpening[Direction.NORTH.getIndex()]) {
            this.makeOpening(worldIn, structureBoundingBoxIn, 3, 5, 15, 4, 6, 15);
         }

         if (oceanmonumentpieces$roomdefinition2.hasOpening[Direction.WEST.getIndex()]) {
            this.makeOpening(worldIn, structureBoundingBoxIn, 0, 5, 11, 0, 6, 12);
         ...
         if (oceanmonumentpieces$roomdefinition2.hasOpening[Direction.EAST.getIndex()]) {
            this.makeOpening(worldIn, structureBoundingBoxIn, 7, 5, 11, 7, 6, 12);
   ...
   public static class EntryRoom extends OceanMonumentPieces.Piece {
      ...
      public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos chunkPosIn) {
         ...
         if (this.roomDefinition.hasOpening[Direction.WEST.getIndex()]) {
            this.makeOpening(worldIn, structureBoundingBoxIn, 0, 1, 3, 1, 2, 4);
         }

         if (this.roomDefinition.hasOpening[Direction.EAST.getIndex()]) {
            this.makeOpening(worldIn, structureBoundingBoxIn, 6, 1, 3, 7, 2, 4);
         }
   ...
   public static class MonumentBuilding extends OceanMonumentPieces.Piece {
      ...
      public MonumentBuilding(Random p_i45599_1_, int p_i45599_2_, int p_i45599_3_, Direction p_i45599_4_) {
         ...
         for(OceanMonumentPieces.RoomDefinition oceanmonumentpieces$roomdefinition : list) {
            if (!oceanmonumentpieces$roomdefinition.claimed && !oceanmonumentpieces$roomdefinition.isSpecial()) {
               ...
               OceanMonumentPieces.IMonumentRoomFitHelper oceanmonumentpieces$imonumentroomfithelper;
               while(true) {
                  if (!lvt_10_1_.hasNext()) {
                     continue label47;
                  }

                  oceanmonumentpieces$imonumentroomfithelper = (OceanMonumentPieces.IMonumentRoomFitHelper)lvt_10_1_.next();
      ...
      public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos chunkPosIn) {
         ...
         this.makeOpening(worldIn, structureBoundingBoxIn, 0, 0, 0, 58, i, 58);
         ...
         for(int l1 = 0; l1 < 5; ++l1) {
            this.makeOpening(worldIn, structureBoundingBoxIn, -1 - l1, 0 + l1 * 2, -1 - l1, -1 - l1, 23, 58 + l1);
            this.makeOpening(worldIn, structureBoundingBoxIn, 58 + l1, 0 + l1 * 2, -1 - l1, 58 + l1, 23, 58 + l1);
            this.makeOpening(worldIn, structureBoundingBoxIn, 0 - l1, 0 + l1 * 2, -1 - l1, 57 + l1, 23, -1 - l1);
            this.makeOpening(worldIn, structureBoundingBoxIn, 0 - l1, 0 + l1 * 2, 58 + l1, 57 + l1, 23, 58 + l1);
         }

         for(OceanMonumentPieces.Piece oceanmonumentpieces$piece : this.childPieces) {
            if (oceanmonumentpieces$piece.getBoundingBox().intersectsWith(structureBoundingBoxIn)) {
               oceanmonumentpieces$piece.addComponentParts(worldIn, randomIn, structureBoundingBoxIn, chunkPosIn);
            }
         }
      ...
      private void generateWing(boolean p_175840_1_, int p_175840_2_, IWorld worldIn, Random p_175840_4_, MutableBoundingBox p_175840_5_) {
         int i = 24;
      ...
      private void generateEntranceArchs(IWorld worldIn, Random p_175839_2_, MutableBoundingBox p_175839_3_) {
      ...
      private void generateEntranceWall(IWorld worldIn, Random p_175837_2_, MutableBoundingBox p_175837_3_) {
      ...
      private void generateRoofPiece(IWorld worldIn, Random p_175841_2_, MutableBoundingBox p_175841_3_) {
      ...
      private void generateLowerWall(IWorld worldIn, Random p_175835_2_, MutableBoundingBox p_175835_3_) {
      ...
      private void generateMiddleWall(IWorld worldIn, Random p_175842_2_, MutableBoundingBox p_175842_3_) {
      ...
      private void generateUpperWall(IWorld worldIn, Random p_175838_2_, MutableBoundingBox p_175838_3_) {
   ...
   public static class MonumentCoreRoom extends OceanMonumentPieces.Piece {
      ...
      public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos chunkPosIn) {
         ...
         int i = 7;
         BlockState blockstate = BRICKS_PRISMARINE;
         this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 7, 0, 0, 7, 15, blockstate, blockstate, false);
         this.fillWithBlocks(worldIn, structureBoundingBoxIn, 15, 7, 0, 15, 7, 15, blockstate, blockstate, false);
         this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, 7, 0, 15, 7, 0, blockstate, blockstate, false);
         this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, 7, 15, 14, 7, 15, blockstate, blockstate, false);
         ...
         for(int k = 1; k <= 6; ++k) {
            ...
            for(int j = 0; j <= 15; j += 15) {
               this.fillWithBlocks(worldIn, structureBoundingBoxIn, j, k, 0, j, k, 1, blockstate, blockstate, false);
               this.fillWithBlocks(worldIn, structureBoundingBoxIn, j, k, 6, j, k, 9, blockstate, blockstate, false);
               this.fillWithBlocks(worldIn, structureBoundingBoxIn, j, k, 14, j, k, 15, blockstate, blockstate, false);
            }

            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, k, 0, 1, k, 0, blockstate, blockstate, false);
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 6, k, 0, 9, k, 0, blockstate, blockstate, false);
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 14, k, 0, 14, k, 0, blockstate, blockstate, false);
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, k, 15, 14, k, 15, blockstate, blockstate, false);
         }
   ...
   public static class Penthouse extends OceanMonumentPieces.Piece {
      ...
      public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos chunkPosIn) {
         ...
         this.makeOpening(worldIn, structureBoundingBoxIn, 6, -1, 3, 7, -1, 4);
   ...
   public abstract static class Piece extends StructurePiece {
      ...
      protected boolean spawnElder(IWorld worldIn, MutableBoundingBox p_175817_2_, int p_175817_3_, int p_175817_4_, int p_175817_5_) {
         ...
         if (p_175817_2_.isVecInside(new BlockPos(i, j, k))) {
            ...
            elderguardianentity.onInitialSpawn(worldIn, worldIn.getDifficultyForLocation(new BlockPos(elderguardianentity)), SpawnReason.STRUCTURE, (ILivingEntityData)null, (CompoundNBT)null);
            worldIn.addEntity(elderguardianentity);
            return true;
         } else {
            return false;
         }
   ...
   public static class SimpleRoom extends OceanMonumentPieces.Piece {
      ...
      public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos chunkPosIn) {
         ...
         boolean flag = this.mainDesign != 0 && randomIn.nextBoolean() && !this.roomDefinition.hasOpening[Direction.DOWN.getIndex()] && !this.roomDefinition.hasOpening[Direction.UP.getIndex()] && this.roomDefinition.countOpenings() > 1;
         ...
         for(int i = 1; i <= 6; ++i) {
            for(int j = 1; j <= 6; ++j) {
               if (randomIn.nextInt(3) != 0) {
                  ...
                  this.fillWithBlocks(worldIn, structureBoundingBoxIn, i, k, j, i, 3, j, blockstate, blockstate, false);
               }
            }
         }
