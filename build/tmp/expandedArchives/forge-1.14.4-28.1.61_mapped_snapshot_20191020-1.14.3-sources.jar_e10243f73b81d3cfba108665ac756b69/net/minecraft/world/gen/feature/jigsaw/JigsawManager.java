...
public class JigsawManager {
   ...
   static final class Assembler {
      ...
      public Assembler(ResourceLocation resourceLocationIn, int p_i50691_2_, JigsawManager.IPieceFactory p_i50691_3_, ChunkGenerator<?> p_i50691_4_, TemplateManager templateManagerIn, BlockPos p_i50691_6_, List<StructurePiece> p_i50691_7_, Random rand) {
         ...
         AbstractVillagePiece abstractvillagepiece = p_i50691_3_.create(templateManagerIn, jigsawpiece, p_i50691_6_, jigsawpiece.func_214850_d(), rotation, jigsawpiece.getBoundingBox(templateManagerIn, p_i50691_6_, rotation));
         ...
         if (p_i50691_2_ > 0) {
            ...
            this.availablePieces.addLast(new JigsawManager.Entry(abstractvillagepiece, new AtomicReference<>(VoxelShapes.combineAndSimplify(VoxelShapes.create(axisalignedbb), VoxelShapes.create(AxisAlignedBB.func_216363_a(mutableboundingbox)), IBooleanFunction.ONLY_FIRST)), k + 80, 0));
