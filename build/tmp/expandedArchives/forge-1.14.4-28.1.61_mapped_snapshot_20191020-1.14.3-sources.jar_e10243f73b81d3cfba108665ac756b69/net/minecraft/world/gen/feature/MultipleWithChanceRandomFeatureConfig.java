...
public class MultipleWithChanceRandomFeatureConfig implements IFeatureConfig {
   ...
   public <T> Dynamic<T> serialize(DynamicOps<T> ops) {
      return new Dynamic<>(ops, ops.createMap(ImmutableMap.of(ops.createString("features"), ops.createList(this.features.stream().map((p_214654_1_) -> {
         return p_214654_1_.serialize(ops).getValue();
