...
public class GameRules {
   ...
   public static <T extends GameRules.RuleValue<T>> GameRules.RuleKey<T> register(String gameRuleName, GameRules.RuleType<T> p_223595_1_) {
   ...
   public CompoundNBT write() {
      ...
      this.rules.forEach((p_223594_1_, p_223594_2_) -> {
         compoundnbt.putString(p_223594_1_.gameRuleName, p_223594_2_.func_223552_b());
      });
      return compoundnbt;
   }
   ...
   public void read(CompoundNBT nbt) {
      this.rules.forEach((p_223591_1_, p_223591_2_) -> {
         p_223591_2_.func_223553_a(nbt.getString(p_223591_1_.gameRuleName));
      });
   }
