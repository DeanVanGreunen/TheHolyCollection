...
public abstract class TicketManager {
   ...
   protected String func_225413_c(long p_225413_1_) {
      ObjectSortedSet<Ticket<?>> objectsortedset = this.tickets.get(p_225413_1_);
      String s;
      if (objectsortedset != null && !objectsortedset.isEmpty()) {
         s = objectsortedset.first().toString();
      } else {
         s = "no_ticket";
      }
   ...
   class PlayerTicketTracker extends TicketManager.PlayerChunkTracker {
      ...
      private void func_215504_a(long chunkPosIn, int p_215504_3_, boolean p_215504_4_, boolean p_215504_5_) {
         if (p_215504_4_ != p_215504_5_) {
            Ticket<?> ticket = new Ticket<>(TicketType.PLAYER, TicketManager.PLAYER_TICKET_LEVEL, new ChunkPos(chunkPosIn), TicketManager.this.currentTime);
            if (p_215504_5_) {
