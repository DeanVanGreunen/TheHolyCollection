...
public final class SnowyTaigaMountainsBiome extends Biome {
   public SnowyTaigaMountainsBiome() {
      super((new Biome.Builder()).surfaceBuilder(SurfaceBuilder.DEFAULT, SurfaceBuilder.GRASS_DIRT_GRAVEL_CONFIG).precipitation(Biome.RainType.SNOW).category(Biome.Category.TAIGA).depth(0.3F).scale(0.4F).temperature(-0.5F).downfall(0.4F).waterColor(4020182).waterFogColor(329011).parent("snowy_taiga"));
