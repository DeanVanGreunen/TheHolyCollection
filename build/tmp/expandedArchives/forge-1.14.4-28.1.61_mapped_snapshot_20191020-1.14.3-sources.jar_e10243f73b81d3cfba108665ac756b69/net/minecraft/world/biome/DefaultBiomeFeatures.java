...
public class DefaultBiomeFeatures {
   ...
   public static void func_225489_aq(Biome p_225489_0_) {
      p_225489_0_.addFeature(GenerationStage.Decoration.SURFACE_STRUCTURES, Biome.createDecoratedFeature(Feature.END_CITY, IFeatureConfig.NO_FEATURE_CONFIG, Placement.NOPE, IPlacementConfig.NO_PLACEMENT_CONFIG));
   }
}